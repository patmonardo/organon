...
/*
  ...
  - Two-fold representation:
    ...
    - concise: short IR summary for HLO extraction (non-destructive)
*/
...
export const CANONICAL_CHUNKS: Chunk[] = [
  {
    ...
    concise: 'Define essence as being that has been sublated (negated-and-preserved).'
  },
  {
...
and according to this being they stand in equal value.`,
    concise: 'Essence = equality-with-self as negation of being; both retain immediacy, yet being is only negative; as immediacies they stand in equal value (indifference).'
  },
  {
...
but is just another existence, the essential.`,
    concise: 'Opposed to essence, being is unessential (sublated). If essence is only an “other” to being, it lapses into mere “essential” existence, not essence proper.'
  },
  {
...
as essential, sometimes as unessential.`,
    concise: 'Treating essential/unessential as a mere separation in an existent is an external positing (by a third standpoint), leaving the content underdetermined and contingent.'
  },
  {
...
it only is a non-essence, shine.`,
    concise: 'Essence is not mere first negation but absolute negativity: being sublating itself as being and as negation. What remains as mere immediacy is null—non-essence (Schein).'
  }
]
...
export const LOGICAL_OPERATIONS: LogicalOperation[] = [
  {
    ...
    candidateSummary: 'Tag Essence as the result of sublation (being negated and preserved).',
    clauses: [
  ...
  },
  {
    ...
    candidateSummary: 'Essence equals self-equality as negation of being; both retain immediacy; as immediacies, being and essence are indifferent (equal value).',
    clauses: [
  ...
  },
  {
    ...
    candidateSummary: 'Opposed to essence, being is unessential (sublated); if essence is only an other to being, it is merely “essential” (another existent), not essence proper.',
    clauses: [
  ...
  },
  {
    ...
    candidateSummary: 'Separation of essential vs unessential by a third standpoint is external positing; leaves content underdetermined.',
    clauses: [
  ...
  },
  {
    ...
    candidateSummary: 'Essence is absolute negativity (self-sublating being and negation). Pure immediacy remaining outside essence is non-essence (Schein).',
    clauses: [
