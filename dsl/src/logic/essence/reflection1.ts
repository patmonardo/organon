...
to that its non-being.`,
    concise: 'External reflection presupposes itself as sublated (negative of itself) and is doubled: (a) immediate-as-presupposed, (b) negative self-reference (to its non-being).'
  },
  {
...
and the determinateness is only as moment.`,
    concise: 'It presupposes a being where immediacy self-refers; determinateness only as moment.'
  },
  {
...
it is only as sublated.`,
    concise: 'Reflection posits and instantly sublates (thus “finds” an immediate presupposition) and starts from it back to itself; whether it is negative/positedness is not its concern here (only as sublated).'
  },
  {
...
standing over against it.`,
    concise: 'External reflection’s posited determinations are external to it. In being: begin from finite as abiding foundation; infinite = reflection-into-itself over against it.'
  },
  {
...
the determinateness or the negation, only to the other extreme.`,
    concise: 'Extremes: immediate vs reflection-into-itself; middle: determinate immediate linking them (immediacy to one extreme, determinateness/negation to the other).'
  },
  {
...
only is in this its beginning.`,
    concise: 'It posits the immediate (as negative/determined) and sublates that positing; negating-of-its-negating. The “alien” negative exists only in and as this beginning.'
  },
  {
...
External reflection is thus determining reflection.`,
    concise: 'Immediate is posited as same as reflection; reflection negates its own determining. Externality is sublated; coincidence with immediate = immediacy of essence. Hence external reflection = immanent/determining reflection; result: essence in-and-for-itself.'
  }
]
...
export const LOGICAL_OPERATIONS: LogicalOperation[] = [
  {
    ...
    candidateSummary: 'External reflection presupposes itself as sublated and splits into immediate-as-presupposed and negative self-reference.',
    clauses: [
  ...
  },
  {
    ...
    candidateSummary: 'External reflection presupposes being with self-referring immediacy; determinateness only as moment.',
    clauses: [
  ...
  },
  {
    ...
    candidateSummary: 'Reflection posits and immediately sublates; hence finds an immediate presupposition to start from and returns, without concern for its “positedness.”',
    clauses: [
  ...
  },
  {
    ...
    candidateSummary: 'What is posited in the immediate is external; in being: begin from finite (abiding), infinite stands as reflection-into-itself against it.',
    clauses: [
  ...
  },
  {
    ...
    candidateSummary: 'Extremes: Immediate vs Reflection-into-itself; Middle: Determinate-immediate connecting them.',
    clauses: [
  ...
  },
  {
    ...
    candidateSummary: 'Posits immediate as negative/determined; sublates this positing; negates its negating; the “alien” negative exists only as this beginning.',
    clauses: [
  ...
  },
  {
    ...
    candidateSummary: 'Immediate is posited as same as reflection; reflection negates its own determining; externality sublated; coincidence with immediate = essence’s immediacy; hence determining reflection (essence in-and-for-itself).',
    clauses: [
