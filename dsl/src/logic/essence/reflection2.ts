...
This is now to be examined more closely.`,
    concise: 'Determining reflection = unity of positing reflection and external reflection.'
  },
  {
...
as reference to the turning back into itself.`,
    concise: 'External begins from being; positing from nothing. External, in determining, posits “other” that is essence; positing has no presupposition, hence its determination is only a posited—immediate yet self-negating, only in reflection-into-itself.'
  },
  {
...
this is the principle of the essence of existence.`,
    concise: 'In essence, positedness corresponds to existence. Existence = positedness; its ground is essence (pure negativity); determinateness is immediately as sublated.'
  },
  {
...
as achieved return into itself.`,
    concise: 'Positedness mediates between existence and essence. Though taken as “subjective,” it is superior: it shows existence as negative referring to return-into-itself. Yet it is “only positedness” with respect to essence: negation of achieved return.'
  },
  {
...
And in this way positedness is a determination of reflection.`,
    concise: 'Uniting positing with external reflection (absolute presupposing) makes positedness a determination: as posited → negation; as presupposed → reflected-into-itself.'
  },
  {
...
as something sublated or posited.`,
    concise: 'Quality: existent negation grounded in being → transient and unequal. Determination of reflection: positedness-as-negation grounded in immanent reflectedness → persists by self-equality, essential, not unequal within itself.'
  },
  {
...
lost in the negation, and negation predominates.`,
    concise: 'Determinations appear as free essentialities (in the void); reflection-into-other is deflected into reflection-into-itself: essential shine. Determining reflection exits from itself; negation predominates.'
  },
  {
...
not in its other, not reflected into its non-being.`,
    concise: 'Side 1: positedness (negation-as-negation), unity implicit; determining abides in itself, distinctions taken back into essence. Side 2: immanent reflection—determinations reflected into themselves; equality not in an other.'
  },
  {
...
whereas its immanent reflectedness is its subsisting.`,
    concise: 'Determination of reflection = positedness (negation vs essence) + immanent self-reference. Positedness = sublatedness; immanent reflectedness = subsistence.'
  },
  {
...
that is, the reference to its negation.`,
    concise: 'Reference to otherness is internal: the determination includes both determinate side and its reference (to its negation) within itself.'
  },
  {
...
and only through this is an essentiality.`,
    concise: 'Unlike quality, determination of reflection internalizes otherness: deflects reference-to-another into itself; equals itself as unity of itself and its other → essentiality.'
  },
  {
...
infinite reference to itself.`,
    concise: 'As self-reflection, positedness is sublated; determination = infinite self-reference.'
  }
]
...
export const LOGICAL_OPERATIONS: LogicalOperation[] = [
  {
    ...
    candidateSummary: 'Determining reflection is the unity/coordination of positing and external reflection.',
    clauses: [
  ...
  },
  {
    ...
    candidateSummary: 'External begins from being; positing from nothing; determination as merely posited—immediate yet self-negating, only in reflection-into-itself.',
    clauses: [
  ...
  },
  {
    ...
    candidateSummary: 'In essence, positedness corresponds to existence; ground = pure negativity; determinateness is immediately sublated.',
    clauses: [
  ...
  },
  {
    ...
    candidateSummary: 'Positedness is the means conjoining existence and essence; “only positedness” has two senses; positedness is superior since existence refers to return-into-itself; yet only with respect to essence.',
    clauses: [
  ...
  },
  {
    ...
    candidateSummary: 'Absolute presupposing (repelling from itself) yields: as posited → negation; as presupposed → reflected-into-itself.',
    clauses: [
  ...
  },
  {
    ...
    candidateSummary: 'Quality = existent negation grounded in being (transient, unequal). Determination of reflection = positedness-as-negation grounded in immanent reflectedness (essential, self-equal).',
    clauses: [
  ...
  },
  {
    ...
    candidateSummary: 'Determinations-as-free-essentialities (void, no attraction/repulsion); reflection-into-other deflected into reflection-into-itself; essential shine; determining reflection exits from itself, negation predominates.',
    clauses: [
  ...
  },
  {
    ...
    candidateSummary: 'Side 1: positedness as negation-as-negation (implicit unity), immediate that self-sublates; determining abides in itself; distinctions taken back into essence. Side 2: reflected-into-themselves; equality not in an other.',
    clauses: [
  ...
  },
  {
    ...
    candidateSummary: 'Determination = positedness (negation vs essence) + immanent reflectedness (subsistence).',
    clauses: [
  ...
  },
  {
    ...
    candidateSummary: 'Determination contains both determinate side and its reference, i.e., reference to its negation, not two externals.',
    clauses: [
  ...
  },
  {
    ...
    candidateSummary: 'Otherness taken back; negation equal-to-itself unifies itself and its other; thereby becomes essential.',
    clauses: [
  ...
  },
  {
    ...
    candidateSummary: 'As reflection-into-itself, positedness is sublated, yielding infinite reference to itself.',
    clauses: [
  ...
  },
  {
    ...
    candidateSummary: 'Truth of Becoming sublated: positedness as sublated; reference-to-otherness internalized; essentiality as infinite self-reference.',
    clauses: [
