...
- **Dataset**: the semantic model builder layer above DataFrame. See [core-concepts.md](../REFERENCES/collections-dataset/core-concepts.md)
- **DatasetPipeline**: the named, typed pipeline envelope. See [core-concepts.md#Pipeline](../REFERENCES/collections-dataset/core-concepts.md#Pipeline)
- **Namespace pattern**: `.ds()` as ergonomic sugar on the modern Polars API. See [frame-dsl.md](../REFERENCES/collections-dataset/frame-dsl.md)
- **DatasetCompilation**: the compiled graph of all pipeline stages. See [core-concepts.md#Compilation](../REFERENCES/collections-dataset/core-concepts.md#Compilation)
