...
- **Source**: a named data origin (file, stream, corpus, API). See [core-concepts.md#Source](../REFERENCES/collections-dataset/core-concepts.md#Source)
- **Corpus**: a source organized as annotated, lineage-tracked documents. See [corpus-structures.md](../REFERENCES/collections-dataset/corpus-structures.md)
- **Provenance**: the lineage metadata attached to every artifact (source_id, specification_id, timestamp). See [provenance.md](../REFERENCES/collections-dataset/provenance.md)
- **SourceReader**: the adapter interface for ingesting concrete data. See [io-and-readers.md](../REFERENCES/collections-dataset/io-and-readers.md)

## Next Exemplar

**Next**: `collections_dataset_tree.rs`
