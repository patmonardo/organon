...
- **Tree**: a parse or semantic structure object. See [tree-structures.md](../REFERENCES/collections-dataset/tree-structures.md)
- **Parse value**: a typed tree node (constituent label, dependency label, syntax role). See [tree-structures.md#ParseValue](../REFERENCES/collections-dataset/tree-structures.md#ParseValue)
- **Span**: a document range `(start, end)` indexed into the corpus. See [spans.md](../REFERENCES/collections-dataset/spans.md)
- **Tree DSL**: the ergonomic operations on trees as tabular data. See [tree-dsl.md](../REFERENCES/collections-dataset/tree-dsl.md)

## Next Exemplar

**Next**: `collections_dataset_featstruct_model.rs`
