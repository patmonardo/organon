...
- **Stdlib resource**: a named, reusable source package. See [stdlib-resources.md](../REFERENCES/collections-dataset/stdlib-resources.md)
- **Source provenance**: the stable origin and local materialization record. See [provenance.md](../REFERENCES/collections-dataset/provenance.md)
- **Resource report**: the fetch result that records archive path, data dir, and size. See [stdlib-resources.md#ResourceReport](../REFERENCES/collections-dataset/stdlib-resources.md#ResourceReport)

## Next Exemplar

**Next**: `collections_dataset_json.rs`
