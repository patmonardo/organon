...
**Source file**: `gds/examples/collections_list_namespace_rustscript.rs`
**Arc position**: Observation (variable-arity mark derivation on open-structure appearances)
**Prior exemplar**: [021 — Array Namespace as Fixed-Arity Observation](021-array-namespace-observation.md)
**Next exemplar**: [023 — String Namespace as Text-Form Observation](023-string-namespace-observation.md)
...
- How null List marks propagate through Principle evaluation (see [Principle Evaluation](../REFERENCES/form-processor/principle-evaluation.md))
- GDSL `appearance` block with `derive` over list columns (see [GDSL Grammar](../REFERENCES/gdsl/grammar.md))
