...
**Source file**: `gds/examples/dataframe_macros_reflection.rs`
**Arc position**: Reflection (Moments 1–6)
**Prior exemplar**: [010 — XML/HTML Semantic Form](../dataset/010-xml-html-semantic-form.md)
**Next exemplar**: [012 — Select/Filter as Principle Evaluation](../dataframe/012-select-filter-principle.md)
...
*See*: [Seven Moments of Reflection](../../REFERENCES/form/seven-moments.md)
