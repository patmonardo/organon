...
**Source file**: `gds/examples/dataframe_expr_pipeline.rs`
**Arc position**: Judgment (Concept → Judgment)
**Prior exemplar**: [013 — Series as Concept Surface](../dataframe/013-series-concept-surface.md)
**Next exemplar**: [015 — Order/Group Exprs as Syllogism](../dataframe/015-order-group-syllogism.md)
...
In external `.gdsl`, this corresponds to a `judgment` block's `infer <label> when <condition>` clause
...
- The external `.gdsl` `judgment` block syntax (see [Shell External Program Grammar](../../REFERENCES/shell/grammar.md))
- Syllogism (explicit middle-term derivation — Exemplar 015)
- Judgment artifact materialization (see [Artifact Materialization](../../REFERENCES/dataset/artifact-materialization.md))
