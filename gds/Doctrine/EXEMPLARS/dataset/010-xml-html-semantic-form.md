...
- **MarkupTokenizer**: turns markup text into token stream. See [structured-sources.md](../../REFERENCES/dataset/structured-sources.md)
- **MarkupParser**: builds semantic tree form from markup tokens. See [structured-sources.md](../../REFERENCES/dataset/structured-sources.md)
- **Document tree**: an observed structure that can later carry marks. See [tree-structures.md](../../REFERENCES/dataset/tree-structures.md)
