...
**Source file**: `gds/examples/dataset_namespace_array.rs`
**Arc position**: Observation (fixed-arity mark derivation on structured appearances)
**Prior exemplar**: [020 — Framing and Chunking as PureForm Shape](../form/020-framing-chunking-pureform.md)
**Next exemplar**: [022 — List Namespace as Variable-Arity Observation](../dataset/022-list-namespace-observation.md)
...
- How array columns appear in external `.gdsl` `appearance` blocks (see [Shell External Program Grammar](../../REFERENCES/shell/grammar.md))
