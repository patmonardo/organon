# GDS Doctrine — Index and Navigation

Welcome. This is the Doctrine of the GDS Knowledge Agent system. It is the constitution
of the platform.
...
**New to GDS?** Read these in order:
...
**In one sentence**: The GDS Knowledge Agent executes scientific knowledge as a deterministic
...
This arc is not negotiable. All GDSL programs follow it. All Dataset artifacts embody it.

---

## The Exemplars (The Core Curriculum)

These are the canonical texts. Study them in order. Each exemplar is an expository document
that shows what a stage of the arc teaches.

### Foundation (Stages 1-2): Surface and Sources

1. **[001-frame-dsl.md](EXEMPLARS/001-frame-dsl.md)**
   File: `gds/examples/collections_dataset_frame_dsl.rs`
   Teaches: The modern Dataset DSL surface. Observation begins.

2. **[002-corpus-readers.md](EXEMPLARS/002-corpus-readers.md)**
   File: `gds/examples/collections_dataset_corpus_readers.rs`
   Teaches: How semantic intent enters through corpus sources. Observation deepens.

### Observation (Stage 2): Structure and Marking

3. **[003-tree-structures.md](EXEMPLARS/003-tree-structures.md)**
   File: `gds/examples/collections_dataset_tree.rs`
   Teaches: Syntactic and semantic trees as first structural articulation. NLTK inheritance.

4. **[004-featstruct-model.md](EXEMPLARS/004-featstruct-model.md)**
   File: `gds/examples/collections_dataset_featstruct_model.rs`
   Teaches: Feature structures as the symbolic algebra. The three-box form processor. Essence preparation.

### The Compiler (Bridge to Reflection)

5. **[005-compile-ir.md](EXEMPLARS/005-compile-ir.md)**
   File: `gds/examples/collections_dataset_compile_ir.rs`
   Teaches: Program Features become Dataset artifacts. The compiler-IR makes it visible.

### Whole-Arc GDSL and Service Surface

6. **[006-gdsl-absolute-concept.md](EXEMPLARS/006-gdsl-absolute-concept.md)**
   File: `gds/examples/collections_dataset_gdsl_absolute_concept.rs`
   Teaches: The first full GDSL specimen compiled into Dataset artifacts.

7. **[007-applications-expository.md](EXEMPLARS/007-applications-expository.md)**
   File: `gds/examples/collections_dataset_applications_expository.rs`
   Teaches: The Dataset-first Applications service boundary.

### Source Ecology and Structured Observation

8. **[008-stdlib-resources.md](EXEMPLARS/008-stdlib-resources.md)**
   File: `gds/examples/collections_dataset_stdlib.rs`
   Teaches: Curated resources as stable source commitments.

9. **[009-json-semantic-form.md](EXEMPLARS/009-json-semantic-form.md)**
   File: `gds/examples/collections_dataset_json.rs`
   Teaches: JSON lowered into observed semantic tree form.

10. **[010-xml-html-semantic-form.md](EXEMPLARS/010-xml-html-semantic-form.md)**
...
11. **[011-dataframe-macros-reflection.md](EXEMPLARS/011-dataframe-macros-reflection.md)**
   File: `gds/examples/collections_dataframe_macros_expository.rs`
   Teaches: DataFrame macros as the Reflection engine.

12. **[012-select-filter-principle.md](EXEMPLARS/012-select-filter-principle.md)**
   File: `gds/examples/collections_select_filter.rs`
   Teaches: Select/filter operations as Principle evaluation.

13. **[013-series-concept-surface.md](EXEMPLARS/013-series-concept-surface.md)**
   File: `gds/examples/collections_series_basic.rs`
   Teaches: Series as Concept surface.

### Judgment, Syllogism, Inference, and Procedure

14. **[014-expr-pipeline-judgment.md](EXEMPLARS/014-expr-pipeline-judgment.md)**
   File: `gds/examples/collections_series_expr_pipeline.rs`
   Teaches: Expr pipelines as Judgment.

15. **[015-order-group-syllogism.md](EXEMPLARS/015-order-group-syllogism.md)**
   File: `gds/examples/collections_order_group_exprs.rs`
   Teaches: Order/group operations as Syllogism.

16. **[016-join-operations-inference.md](EXEMPLARS/016-join-operations-inference.md)**
   File: `gds/examples/collections_join_operations.rs`
   Teaches: Joins as cross-population Inference.

17. **[017-streaming-dataset-procedure.md](EXEMPLARS/017-streaming-dataset-procedure.md)**
   File: `gds/examples/collections_streaming_dataset.rs`
   Teaches: Streaming Dataset as Procedure and Process emission.

18. **[018-streaming-lazy-deferred.md](EXEMPLARS/018-streaming-lazy-deferred.md)**
   File: `gds/examples/collections_streaming_lazy.rs`
   Teaches: Lazy streaming as deferred Procedure collection.

19. **[019-expr-basic-judgment-grammar.md](EXEMPLARS/019-expr-basic-judgment-grammar.md)**
   File: `gds/examples/collections_expr_basic.rs`
   Teaches: Expr as reusable Judgment grammar.

20. **[020-framing-chunking-pureform.md](EXEMPLARS/020-framing-chunking-pureform.md)**
   File: `gds/examples/collections_extensions_framing_chunking.rs`
   Teaches: Framing and chunking as PureForm shape.

### Namespaces and Artifact Persistence

21. **[021-array-namespace-observation.md](EXEMPLARS/021-array-namespace-observation.md)**
   File: `gds/examples/collections_array_namespace_rustscript.rs`
   Teaches: Array namespace as fixed-arity Observation.

22. **[022-list-namespace-observation.md](EXEMPLARS/022-list-namespace-observation.md)**
   File: `gds/examples/collections_list_namespace_rustscript.rs`
   Teaches: List namespace as variable-arity Observation.

23. **[023-string-namespace-observation.md](EXEMPLARS/023-string-namespace-observation.md)**
   File: `gds/examples/collections_string_namespace_rustscript.rs`
   Teaches: String namespace as text-form Observation.

24. **[024-catalog-extension-persistence.md](EXEMPLARS/024-catalog-extension-persistence.md)**
   File: `gds/examples/collections_catalog_extensible.rs`
   Teaches: Catalog extension as artifact persistence.

25. **[025-graphframe-catalog-write.md](EXEMPLARS/025-graphframe-catalog-write.md)**
...
When an exemplar points to a reference, consult that file for deeper definition.
References are organized by topic, not by project.
...
- [provenance.md](REFERENCES/collections-dataset/provenance.md) — Required lineage fields for artifacts
- [structured-sources.md](REFERENCES/collections-dataset/structured-sources.md) — JSON/XML/HTML as observed form
- [stdlib-resources.md](REFERENCES/collections-dataset/stdlib-resources.md) — Curated resources as source commitments
- [tree-structures.md](REFERENCES/collections-dataset/tree-structures.md) — Observed tree structure
- [tree-dsl.md](REFERENCES/collections-dataset/tree-dsl.md) — Operations over tree artifacts
- [feature-structures.md](REFERENCES/collections-dataset/feature-structures.md) — Symbolic semantic marking algebra
- [unification.md](REFERENCES/collections-dataset/unification.md) — Merging compatible feature structures
...
- [seven-moments.md](REFERENCES/form-processor/seven-moments.md) — The seven moments of Reflection. Absolute Reflection as threshold.
- [relative-reflection.md](REFERENCES/form-processor/relative-reflection.md) — Moments 1-6 of Reflection
- [absolute-reflection.md](REFERENCES/form-processor/absolute-reflection.md) — Moment 7, threshold before Principle
- [principle-evaluation.md](REFERENCES/form-processor/principle-evaluation.md) — Principle as nomological gate before Concept
- [concept-emergence.md](REFERENCES/form-processor/concept-emergence.md) — Concept as post-Principle scientific object

### GDSL

- [program-features.md](REFERENCES/gdsl/program-features.md) — The 16-variant ProgramFeatureKind taxonomy
- [grammar.md](REFERENCES/gdsl/grammar.md) — Canonical GDSL program syntax and reading rule
...
- [hegel-objectivity.md](REFERENCES/philosophy/hegel-objectivity.md) — Procedure as Process
- [kant-synthesis.md](REFERENCES/philosophy/kant-synthesis.md) — Observation stage
...
At **Absolute Reflection (Moment 7)**, both kernel and agent read the same shape data
without marshaling. This is where Principle is evaluated and Concept is permitted to emerge.
...
1. All changes should fit the arc
2. New features are new stages or sub-stages, not new options
3. Update the exemplars first; reference docs follow
4. All artifacts must carry provenance
5. Verify ZeroCopy correctness at the Principle boundary

### For Contributors

1. Identify which stage your contribution serves
2. Write or update an exemplar showing it in context
3. Update reference docs based on what the exemplar teaches
4. Ensure provenance is carried through
5. Link to the arc clearly

### For Reviewers

1. Does the change fit the arc?
2. Are the exemplars updated?
3. Is provenance preserved?
4. Is the ZeroCopy boundary still clean?
5. Does it read as Doctrine, or as scattered notes?

---

## Archived Documentation

The previous `/gds/doc` directory contained ~100 scattered working notes, proposals, and
...
Read the exemplars in order. Consult the references when you need depth. Build something
using the same pattern. You now own the system.

The arc is canonical. The zero-copy boundary is sacred. Principle comes before Concept.
Procedure is entry into Objectivity. Everything else serves the examples.
