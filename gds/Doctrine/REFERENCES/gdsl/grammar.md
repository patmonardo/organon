...
GDSL is the authoring language for scientific knowledge programs. It names sources, observations, reflection paths, principles, concepts, judgments, syllogisms, queries, and procedures.
...
Read a GDSL file as a scientific knowledge arc, not as a data pipeline script.
