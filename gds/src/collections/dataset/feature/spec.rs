//! Structural Feature specification vocabulary.
//!
//! These types support Feature matching, extraction, and rule expansion. They
//! live with the Feature machinery rather than the script-facing DSL expression
//! Component.
