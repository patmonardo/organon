...
use crate::collections::dataset::dsl::namespaces::text::TextNs;
...
impl DatasetToolChain {
    ...
    pub fn dataop() -> crate::collections::dataset::dsl::namespaces::dataop::DataOpNs {
        crate::collections::dataset::dsl::namespaces::dataop::DataOpNs
    }
