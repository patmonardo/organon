...
//!
//! Lives under the Dataset language domain beside [`super::tree`], so the
//! "text + tree + feature-grammar" world stays together while the Dataset
//! root remains focused on the execution spine.
