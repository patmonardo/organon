...
//!
//! Lives under the Dataset language domain beside [`super::tree`], while
//! still pairing with [`super::grammar`] to complete the
//! "text + tree + feature-grammar" triple.

use std::collections::{BTreeMap, BTreeSet};

use crate::collections::dataset::language::stats::FreqDist;
use crate::collections::dataset::language::text::collocations::{
