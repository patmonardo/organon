...
mod tests {
    ...
    fn sort_rows(mut rows: Vec<FilteredKnnResultRow>) -> Vec<(u64, u64, f64)> {
        rows.sort_by(|a, b| {
            a.source
                .cmp(&b.source)
    ...
    fn stream_parallel_matches_single_worker() {
        ...
        let single = FilteredKnnFacade::new(Arc::clone(&store), "random_score")
            .k(5)
            .sampled_k(3)
            .max_iterations(4)
            .similarity_cutoff(0.0)
        ...
        let parallel = FilteredKnnFacade::new(store, "random_score")
            .k(5)
            .sampled_k(3)
            .max_iterations(4)
            .similarity_cutoff(0.0)
