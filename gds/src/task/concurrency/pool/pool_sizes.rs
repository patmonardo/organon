...
///
/// ```
/// use gds::task::concurrency::pool::{PoolSizes, default, fixed};
///
/// let pool = default();
...
///
/// ```
/// use gds::task::concurrency::pool::{PoolSizes, default};
///
/// let pool = default();
/// assert_eq!(pool.core_pool_size(), 4);
/// ```
...
///
/// ```
/// use gds::task::concurrency::pool::{PoolSizes, fixed};
///
/// let pool = fixed(8);
...
///
/// ```
/// use gds::task::concurrency::pool::{PoolSizes, single_threaded};
///
...
///
/// ```
/// use gds::task::concurrency::pool::{PoolSizes, from_cpu_cores};
///
...
///
/// ```
/// use gds::task::concurrency::pool::{PoolSizes, custom};
///
