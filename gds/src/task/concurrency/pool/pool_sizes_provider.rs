...
///
/// ```
/// use gds::task::concurrency::pool::{LicenseState, PoolSizesProvider};
///
/// let license = LicenseState::Open;
/// let provider = PoolSizesProvider;
/// let pool = provider.get(license);
/// assert_eq!(pool.core_pool_size(), gds::task::concurrency::OPEN_GDS_DEFAULT_CONCURRENCY);
/// ```
...
///
/// ```
/// use gds::task::concurrency::pool::{PoolSizes, PoolSizesProvider, LicenseState};
///
/// let provider = PoolSizesProvider;
...
impl PoolSizesProvider {
    ...
    ///
    /// ```
    /// use gds::task::concurrency::pool::PoolSizesProvider;
    ///
    /// let provider = PoolSizesProvider;
...
///
/// ```
/// use gds::task::concurrency::pool::{PoolSizes, PoolSizesService};
///
...
mod tests {
    ...
    use super::*;
    use crate::task::concurrency::OPEN_GDS_DEFAULT_CONCURRENCY;
