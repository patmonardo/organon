...
///
/// ```
/// use gds::task::concurrency::validator::{ConcurrencyValidator, OpenGdsConcurrencyValidator};
///
...
///
/// ```
/// use gds::task::concurrency::validator::{OpenGdsConcurrencyValidatorBuilder, LicenseState};
///
...
impl OpenGdsConcurrencyValidatorBuilder {
    ...
    ///
    /// ```
    /// use gds::task::concurrency::validator::{ConcurrencyValidator, OpenGdsConcurrencyValidatorBuilder, LicenseState};
    ///
    /// let builder = OpenGdsConcurrencyValidatorBuilder;
    /// let validator = builder.build(LicenseState::Open);
    /// assert!(validator.validate(4, "concurrency", 4).is_ok());
    ...
    ///
    /// ```
    /// use gds::task::concurrency::validator::OpenGdsConcurrencyValidatorBuilder;
    ///
    /// let builder = OpenGdsConcurrencyValidatorBuilder;
