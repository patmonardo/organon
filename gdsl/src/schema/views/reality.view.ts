...
export const REALITY_VIEW: View = {
  ...
  terms: [
    ...
    {
      id: 'HegelSystemOfSystems',
      label: 'Hegel — System of Systems',
      aliases: ['Hegel'],
    },
    ...
    {
      id: 'PrincipleOfLight',
      label: 'Principle of Light (Vitarka)',
      aliases: [],
    },
  ],
  edges: [
