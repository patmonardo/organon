...
class Being {
    ...
    public describe(): string {
        return "Being is pure and indeterminate, without further determination.";
    }
}
...
class Existence extends Being {
    ...
    public describe(): string {
        return `Existence is the realization of being with quality:
...
class BeingForSelf extends Being {
    ...
    public describe(): string {
        return `Being-for-Self is the self-referential aspect of existence:
