...
class Existence extends Being {
    ...
    public describe(): string {
        return `Existence is the manifestation of being that incorporates quality. 
        It is characterized by the following quality: ${this.quality.describe()}`;
    }
}
...
class BeingForSelf extends Being {
    ...
    public describe(): string {
        return `Being-for-Self represents a self-referential existence. 
        It acknowledges its own existence and the quality that defines it: ${this.existence.describe()}`;
    }
}
