...
MERGE (ir:TopicMapIR {id: 'reflection-essence-topicmap-ir'}) SET ir.mode = 'debug', ir.title = 'Reflection-Essence TopicMap IR', ir.section = 'Doctrine of Essence / Reflection / Essence', ir.generatedAt = '2026-02-17T22:47:29.033Z', ir.totalSources = 3, ir.totalChunks = 41;
...
MATCH (ir:TopicMapIR {id: 'reflection-essence-topicmap-ir'})
...
MATCH (a:TopicMapChunk {id: 'ess-12'})
MATCH (b:TopicMapChunk {id: 'shn-1'})
MERGE (a)-[r:SUBLATES]->(b)
SET r.reason = 'Essential/unessential opposition passes into shine as non-essence.';
MATCH (a:TopicMapChunk {id: 'shn-10'})
MATCH (b:TopicMapChunk {id: 'ref-1'})
MERGE (a)-[r:REFLECTS]->(b)
