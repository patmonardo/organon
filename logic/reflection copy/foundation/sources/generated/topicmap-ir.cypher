...
MERGE (ir:TopicMapIR {id: 'reflection-foundation-topicmap-ir'}) SET ir.mode = 'debug', ir.title = 'Reflection-Foundation TopicMap IR', ir.section = 'Doctrine of Essence / Reflection / Foundation', ir.generatedAt = '2026-02-17T22:47:29.486Z', ir.totalSources = 3, ir.totalChunks = 31;
...
SET s.totalLines = 64;
MATCH (ir:TopicMapIR {id: 'reflection-foundation-topicmap-ir'})
...
MATCH (b:TopicMapChunk {id: 'diff-1'})
MERGE (a)-[r:SUBLATES]->(b)
