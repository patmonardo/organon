// Neo4j Query Pack — Integrated Real Measure IR
// IR: integrated-real-measure-topicmap-ir
// Generated for section: Doctrine of Being / Measure / Real Measure
...
MATCH (c:IntegratedChunk {id: 'rm-c-8-progressive-determination-summary'})-[:HAS_KEY_POINT]->(k:KeyPoint)
