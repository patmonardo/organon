...
- Use ID prefix `spq-c` for Part C entries.
...
### Entry spq-c-001 — Immediate qualitative subsistence against specified relation

Span:

- sourceFile: `src/compiler/being/measure/specific-quantity/sources/being-for-itself.txt`
- lineStart: 4
- lineEnd: 51
...
- r1. type: supports
  ...
  - sourceClaimIds: [`spq-c-001-c3`]
  - sourceKeyPointIds: [`k4`]
  - targetClaimIds: [`spq-b-c-002-c3`]
  - logicalOperator: implicative_support
  - analysisMode: first_order_claim_projection

- r2. type: transitions_to
  - targetEntryId: spq-c-002
  - note: unresolved immediacy drives analysis of empirical coefficient/exponent in determinate relation.
  - sourceClaimIds: [`spq-c-001-c2`, `spq-c-001-c3`]
  - sourceKeyPointIds: [`k3`, `k4`]
  - targetClaimIds: [`spq-c-002-c1`]
...
### Entry spq-c-002 — Empirical coefficient and conceptual exponent in the falling-body ratio
...
### Entry spq-c-003 — Real being-for-itself as unity and repulsion of measure-determined somethings
...
- r1. type: transitions_to
  ...
  - sourceClaimIds: [`spq-c-003-c2`, `spq-c-003-c3`]
  - sourceKeyPointIds: [`k3`, `k4`]
