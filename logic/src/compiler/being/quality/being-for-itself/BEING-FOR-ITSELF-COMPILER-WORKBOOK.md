...
- Contract reference: `src/compiler/being/quality/being-for-itself/WORKBOOK-CONTRACT-V1.md`
...
- sourceFile: `src/compiler/being/quality/being-for-itself/being-for-itself.txt`
- lineStart: 35
- lineEnd: 47
...
- c1. id: bfs-compiler-001-c1
  ...
  - confidence: 0.97
  - evidence:
    - [35-47] explicit three-step progression in `being-for-itself.txt`.
...
- c3. id: bfs-compiler-001-c3
  ...
  - confidence: 0.96
  - evidence:
    - [43-47] quality passes over into quantity in `being-for-itself.txt`.
