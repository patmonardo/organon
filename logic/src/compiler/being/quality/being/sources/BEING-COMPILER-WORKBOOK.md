...
- This workbook markdown is the authoritative Knowledge Graph artifact for compiler-facing Being modeling.
...
- files:
  ...
  - `nothing.txt`
  - `becoming.txt`
- focus: compiler-oriented relation normalization for Being (`Transition` and `TruthOf` alignment)

Decision:

- Maintain claim-level compatibility with `BEING-PART-A/B/C-WORKBOOK.md`.
