...
export type BecomingConceptTopic = {
  id: string;
  name: string;
 ...
 *
 * This TopicMap follows C. BECOMING in the source text.
 * Focuses on the Species
...
/**
 * Concept-level topic map for C. BECOMING.
 *
 * This is intentionally separate from `becomingTopicMap` (chunk-plan entries).
 * It models conceptual topics and their conceptual adjacency, each grounded by
 * one or more evidence chunks.
 */
export const becomingConceptTopics: BecomingConceptTopic[] = [
  {
    id: 'concept-becoming-being',
    name: 'Being',
    parentId: 'concept-becoming-root',
    relatedTo: ['concept-becoming-nothing', 'concept-becoming-becoming'],
    evidenceChunks: ['becoming-1', 'becoming-2', 'becoming-3', 'becoming-4'],
  },
  {
    id: 'concept-becoming-nothing',
    name: 'Nothing',
    parentId: 'concept-becoming-root',
    relatedTo: ['concept-becoming-being', 'concept-becoming-becoming'],
    evidenceChunks: ['becoming-1', 'becoming-2', 'becoming-3', 'becoming-4'],
  },
  {
    id: 'concept-becoming-becoming',
    name: 'Becoming',
    parentId: 'concept-becoming-root',
    relatedTo: ['concept-becoming-being', 'concept-becoming-nothing'],
    evidenceChunks: ['becoming-1', 'becoming-2', 'becoming-3', 'becoming-4'],
  },
  {
    id: 'concept-becoming-coming-to-be',
    name: 'Coming-to-be',
    parentId: 'concept-becoming-moments',
    relatedTo: ['concept-becoming-ceasing-to-be'],
    evidenceChunks: ['becoming-3', 'becoming-4'],
  },
  {
    id: 'concept-becoming-ceasing-to-be',
    name: 'Ceasing-to-be',
    parentId: 'concept-becoming-moments',
    relatedTo: ['concept-becoming-coming-to-be'],
    evidenceChunks: ['becoming-3', 'becoming-4'],
  },
  {
    id: 'concept-becoming-unity',
    name: 'Unity of being and nothing',
    parentId: 'concept-becoming-structure',
    relatedTo: ['concept-becoming-unseparatedness'],
    evidenceChunks: ['becoming-1', 'becoming-2', 'becoming-3'],
  },
  {
    id: 'concept-becoming-unseparatedness',
    name: 'Unseparatedness',
    parentId: 'concept-becoming-structure',
    relatedTo: ['concept-becoming-unity'],
    evidenceChunks: ['becoming-2'],
  },
  {
    id: 'concept-becoming-vanishing',
    name: 'Vanishing',
    parentId: 'concept-becoming-sublation',
    relatedTo: ['concept-becoming-vanishedness'],
    evidenceChunks: ['becoming-5', 'becoming-6'],
  },
  {
    id: 'concept-becoming-vanishedness',
    name: 'Vanishedness',
    parentId: 'concept-becoming-sublation',
    relatedTo: ['concept-becoming-vanishing'],
    evidenceChunks: ['becoming-6'],
  },
  {
    id: 'concept-becoming-existence',
    name: 'Existence',
    parentId: 'concept-becoming-sublation',
    relatedTo: ['concept-becoming-becoming'],
    evidenceChunks: ['becoming-7'],
  },
  {
    id: 'concept-becoming-root',
    name: 'C. Becoming',
    parentId: null,
    evidenceChunks: [
      'becoming-1',
  ...
  {
    id: 'concept-becoming-moments',
    name: 'Moments of becoming',
    parentId: 'concept-becoming-root',
    evidenceChunks: ['becoming-2', 'becoming-3', 'becoming-4'],
  },
  {
    id: 'concept-becoming-structure',
    name: 'Structure of becoming',
    parentId: 'concept-becoming-root',
    evidenceChunks: ['becoming-1', 'becoming-2', 'becoming-3'],
  },
  {
    id: 'concept-becoming-sublation',
    name: 'Sublation of becoming',
    parentId: 'concept-becoming-root',
    evidenceChunks: ['becoming-5', 'becoming-6', 'becoming-7'],
  },
];
