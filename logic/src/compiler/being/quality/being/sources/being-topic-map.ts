 ...
 *
 * This TopicMap follows A. BEING in the source text.
 * Focuses on the Species (A. BEING) only,
 * ignoring top-level Genus introduction.
 *
 * Structure: Pure being without further determination → Being as emptiness and nothing
 */
