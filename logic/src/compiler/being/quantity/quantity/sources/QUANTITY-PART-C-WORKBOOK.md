...
- Contract reference: `src/compiler/being/quantity/quantity/sources/WORKBOOK-CONTRACT-V1.md`
...
- sourceFile: `src/compiler/being/quantity/quantity/sources/limiting-quantity.txt`
- lineStart: 4
- lineEnd: 23
