// Neo4j Query Pack — Integrated Quantum IR
// IR: integrated-quantum-topicmap-ir
// Generated for section: Doctrine of Being / Quantity / Number-Quantum-Infinity
...
MATCH (c:IntegratedChunk {id: 'infinity-quantum-return-quality'})-[:HAS_KEY_POINT]->(k:KeyPoint)
