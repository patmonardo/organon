// Neo4j Query Pack — Integrated Ratio IR
// IR: integrated-ratio-topicmap-ir
// Generated for section: Doctrine of Being / Quantity / Ratio
...
MATCH (c:IntegratedChunk {id: 'powers-double-transition-measure'})-[:HAS_KEY_POINT]->(k:KeyPoint)
