...
async function main() {
  ...
  for (const sourceSpec of sourceSpecs) {
    ...
    const chunks: TopicMapChunk[] = sourceSpec.topicMap.map(
      (entry, index) => {
  ...
  const topLevelTs = renderTopicMapFile(
    'topicmapActualityActualityTopicMapIR',
    'ActualityActualityTopicMapIR',
    'topicmapActualityActualityTopicMap',
    ir,
  );
