// Neo4j Query Pack — Integrated Specific Quantity IR
// IR: integrated-specific-quantity-topicmap-ir
// Generated for section: Doctrine of Being / Measure / Specific Quantity
...
MATCH (c:IntegratedChunk {id: 'sq-c-4-unity-of-measures'})-[:HAS_KEY_POINT]->(k:KeyPoint)
