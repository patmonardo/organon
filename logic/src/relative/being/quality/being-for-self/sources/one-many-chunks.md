# Chunking Plan for one-many.txt - B. THE ONE AND THE MANY
...
- Both posited as affirmative existence
- Each referring to other as to other existence
- Essentially, being-for-itself of one is ideality of existence and other
- Does not refer to other but only to itself
- Being-for-itself fixed as one, as existent for itself, immediately present
- Negative reference to itself is reference to existent
- Other determined as existence and as other, likewise a one
