# Chunking Plan for constitution.txt - B. FINITUDE (b) Determination, constitution, and limit
...
- Transition: Sublation → two somethings; negation immanent; limit emerges (lines 163-227)
- 3. Limit: (a) Non-being of other and of something; mediation (lines 245-285)
  - (b) Existence outside/inside limit; limit as middle point (lines 287-312)
  - (c) Something outside limit = existence in general; limit as principle; unrest/contradiction (lines 314-405)
- Conclusion: Something with immanent limit = finite (lines 407-410)
...
- In-itselfness = non-being of otherness contained in it but distinct as existent
...
- One determinateness of two somethings: as negation of negation identical with in-itselfness; as negations to each other as other somethings, joins and separates them
