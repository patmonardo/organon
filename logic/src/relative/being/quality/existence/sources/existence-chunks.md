# Chunking Plan for existence.txt - A. EXISTENCE AS SUCH
...
**Structure**: A. EXISTENCE AS SUCH (268 lines)

- Outline: determinateness → quality (reality|negation) → something (lines 4-13)
- a. Existence in general: From becoming, da-sein, reflection vs posited (lines 15-100)
- b. Quality: Immediate unity, reality and negation, limit/restriction (lines 102-155)
- c. Something: Negation of negation, beginning of subject, mediation-with-itself, alteration (lines 157-267)

**Note**: This is the first moment of Qualitative Logic—the determinate being that emerges from Becoming. Existence completes the foundational structure: Being → Nothing → Becoming → Existence (Quality → Something).
...
- `existence-topic-map.ts` - Formal TopicMap structure (Topics)

**TopicMap**: See `existence-topic-map.ts` for the formal TopicMap structure that maps to:
...
### Chunk 1: Outline — determinateness → quality (reality|negation) → something
...
### Chunk 2: Existence from becoming — simple oneness; immediate (mediation behind it)
...
### Chunk 3: "Da"-sein: being with non-being; determinateness as such (in form of being)
...
### Chunk 4: Reflection vs posited I: being-as-moment (for us) vs determinateness-posited (in it)
...
### Chunk 5: Reflection vs posited II: scope of commentary vs moments of the fact itself
...
### Chunk 6: Correspondence: being (indeterminate) vs existence (determinate being, concrete)
...
### Chunk 7: Quality I: immediacy of unity (existent = non-being to that extent)
...
### Chunk 8: Quality II: definition (existent determinateness; simple, immediate)
...
### Chunk 9: Quality III: reality and negation; reflection; limit/restriction
...
### Chunk 10: Quality IV: valuation of reality vs negation (both are existence)
...
### Chunk 11: Something I: reality ∧ negation as existences; quality unseparated from existence
...
### Chunk 12: Something II: sublation (not omission) → simplicity mediated → being-in-itself
...
### Chunk 13: Something III: negation of negation; beginning of the subject
...
### Chunk 14: Something IV: mediation-with-itself (vs alleged bare immediacy)
...
### Chunk 15: Something V: mediation-only collapses to unity; becoming with moments as existents (other)
...
### Chunk 16: Something VI: alteration; initially only in concept; other as qualitative
