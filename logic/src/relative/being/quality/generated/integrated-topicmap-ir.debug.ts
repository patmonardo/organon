...
export const integratedQualityTopicMapDebug = 
{
  "id": "integrated-being-quality-topicmap-ir",
  "mode": "debug",
  "title": "Integrated Quality TopicMap IR",
  "section": "Doctrine of Being / Quality",
  "sourceDocuments": [
    {
      "id": "source-being",
      "title": "A. BEING",
  ...
  "traces": [
    ...
    },
    {
      ...
      "toChunkId": "being-2",
      "type": "MEDIATES",
      "reason": "Dialectical transition inferred from being-2 semantics."
    },
    {
    ...
    },
    {
      ...
      "toChunkId": "becoming-2",
      "type": "SUBLATES",
      "reason": "Dialectical transition inferred from becoming-2 semantics."
    },
    {
    ...
    },
    {
      ...
      "toChunkId": "becoming-3",
      "type": "MEDIATES",
      "reason": "Dialectical transition inferred from becoming-3 semantics."
    },
    {
    ...
    },
    {
      ...
      "toChunkId": "becoming-4",
      "type": "SUBLATES",
      "reason": "Dialectical transition inferred from becoming-4 semantics."
    },
    {
    ...
    },
    {
      ...
      "toChunkId": "becoming-6",
      "type": "SUBLATES",
      "reason": "Dialectical transition inferred from becoming-6 semantics."
    },
    {
    ...
    },
    {
      ...
      "toChunkId": "becoming-7",
      "type": "MEDIATES",
      "reason": "Dialectical transition inferred from becoming-7 semantics."
    },
    {
      "fromChunkId": "being-2",
      "toChunkId": "nothing-1",
    ...
    {
      "fromChunkId": "becoming-7",
      "toChunkId": "being-for-self-a",
      "type": "SUBLATES",
      "reason": "Existence as result of becoming advances into being-for-itself as explicit self-reference."
    }
  ],
  "metadata": {
    "totalSources": 6,
    "totalChunks": 24,
    "generatedAt": "2026-02-17T15:35:14.308Z"
  }
} as const;

export type IntegratedQualityTopicMapDebug = typeof integratedQualityTopicMapDebug;
