// Neo4j Query Pack — Integrated Quality IR
// IR: integrated-being-quality-topicmap-ir
// Generated for section: Doctrine of Being / Quality
...
MATCH (c:IntegratedChunk {id: 'becoming-7'})-[:HAS_KEY_POINT]->(k:KeyPoint)
