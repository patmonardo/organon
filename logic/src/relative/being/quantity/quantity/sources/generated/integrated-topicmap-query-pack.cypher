// Neo4j Query Pack — Integrated Quantity IR
// IR: integrated-quantity-topicmap-ir
// Generated for section: Doctrine of Being / Quantity / Pure Quantity-Magnitude-Limiting
...
MATCH (c:IntegratedChunk {id: 'quantity-pure-unity'})-[:HAS_KEY_POINT]->(k:KeyPoint)
