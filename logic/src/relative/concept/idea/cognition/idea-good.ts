...
/**
 * SPECIES B: THE IDEA OF THE GOOD
 * 
 * The practical idea: will, good, realization, and transition to the absolute idea.
 */

export const CANONICAL_CHUNKS: Chunk[] = [
  {
    id: 'cognition-b-1-practical-idea',
    title: 'Practical idea — the good',
    text: `Inasmuch as the concept,
...
the purpose that on its own wants to give itself
...
giving itself reality in the form of external actuality.`,
    summary: 'Concept determined in and for itself = subject as singular. Has implicit otherness as presupposition, impulse to realize itself, purpose giving objectivity. Theoretical idea: subjective concept = universal lacking determination, opposed to objective world. Practical idea: as actual over against actual, certainty of actuality, non-actuality of world, singularity. Subject vindicated objectivity, inner determinateness = objective = universality absolutely determined. Objective world = posited/immediate/nullity. Determinateness in concept = good. Good = absolute dignity, totality of concept, objective in free unity/subjectivity. Superior to cognition idea (universal + absolutely actual). Impulse = self-positing, to give empty form of immediacy. Activity = positing own determination, sublating external world, giving reality.'
  },
  {
    id: 'cognition-b-2-finitude-good',
    title: 'Finitude of the good — ought',
    text: `The idea of the will as a self-determining
...
an impervious realm of darkness.`,
    summary: 'Will = self-determining, possesses content. Content = determinate = finite/restricted. Self-determination = particularization, will = negative unity = singularity excluding other. Particularity = infinite by form of concept, infinite singularity. Finitude = idea not yet realized. Concept = exists in and for itself. Subjective = absolute (not posited/arbitrary). Being-for-itself not yet being-in-itself. Good = valid in and for itself, particular purpose, already true. Good finite = fate of finitude. Realized good = external existence = accidental/fragile, not corresponding to idea. Several kinds of good, subject to destruction, collision/conflict. Realization exposed to obstacles/impossible. Good = ought, being = non-being. Fulfilled good = absolute postulate = absolute encumbered with subjectivity. Two worlds in opposition: subjectivity (transparent thought) vs objectivity (manifold actuality/darkness).'
  },
  {
    id: 'cognition-b-3-transition-absolute-idea',
    title: 'Transition to absolute idea',
    text: `But what the practical idea still lacks is
...
This is the absolute idea.`,
    summary: 'Practical idea lacks: moment of real consciousness, actuality with external being determination, moment of theoretical idea. Theoretical: concept = universality, cognition = apprehension/indeterminate identity, objectivity = given. Practical: actuality = nullity, will separates from cognition. Good finds completion in true. Transition through itself. Syllogism of action: first premise = immediate reference, second premise = external means. Good = objective for subjective concept. Abstract being sublated by practical idea. First premise = immediate objectivity, purpose communicated without resistance = identity. Second premise = mediation, realization = necessary mediation. First premise = first negation/otherness, second premise = sublation of otherness = actuality of good = concept existing for itself = free concept. State sublated in realization, view vanishes. Activity = positing implicit identity. Actuality = appearance/nullity, altered by activity, posited as existing in and for itself. Presupposition sublated, mediation sublated, result = immediacy (presupposition as sublated). Idea determined in and for itself = immediate actuality = objectivity truly exists. Subject = free universal self-identity, objectivity = given. Cognition restored/united with practical idea. Reality = realized absolute purpose, objective world with concept as inner ground/subsistence = absolute idea.'
  },
];

export const LOGICAL_OPERATIONS: LogicalOperation[] = [
  {
    id: 'cognition-op-b-1-practical-idea',
    chunkId: 'cognition-b-1-practical-idea',
    label: 'Practical idea and the good',
    clauses: [
      'concept.determinedInAndForItself = true',
      'subject = singular',
      'subject.has = implicitOtherness',
      'impulse = realizeItself',
      'purpose = giveObjectivity',
      'theoreticalIdea.subjectiveConcept = universalLackingDetermination',
      'practicalIdea = actualOverAgainstActual',
      'certainty = actuality',
      'certainty = nonActualityOfWorld',
      'subject.vindicatedObjectivity = true',
      'innerDeterminateness = objective',
      'innerDeterminateness = universalityAbsolutelyDetermined',
      'objectiveWorld = posited',
      'objectiveWorld = nullity',
      'determinatenessInConcept = good',
      'good = absoluteDignity',
      'good = totalityOfConcept',
      'good = objectiveInFreeUnity',
      'good.superiorTo = cognitionIdea',
      'impulse = selfPositing',
      'activity = positingOwnDetermination',
      'activity = sublatingExternalWorld',
    ],
    predicates: [
      { name: 'IsGood', args: ['determinatenessInConcept'] },
      { name: 'IsPracticalIdea', args: ['idea'] },
    ],
    relations: [
      { predicate: 'is', from: 'determinatenessInConcept', to: 'good' },
      { predicate: 'isSuperiorTo', from: 'good', to: 'cognitionIdea' },
    ],
  },
  {
    id: 'cognition-op-b-2-finitude',
    chunkId: 'cognition-b-2-finitude-good',
    label: 'Finitude of the good',
    clauses: [
      'will = selfDetermining',
      'content = determinate',
      'content = finiteRestricted',
      'selfDetermination = particularization',
      'will = negativeUnity',
      'will = singularity',
      'particularity = infinite',
      'finitude = ideaNotYetRealized',
      'subjective = absolute',
      'beingForItself.notYetBeingInItself = true',
      'good = validInAndForItself',
      'good = particularPurpose',
      'good.alreadyTrue = true',
      'good.finite = fateOfFinitude',
      'realizedGood = externalExistence',
      'realizedGood = accidentalFragile',
      'good.remains = ought',
      'being = nonBeing',
      'fulfilledGood = absolutePostulate',
      'twoWorldsInOpposition = true',
    ],
    predicates: [
      { name: 'IsFinite', args: ['good'] },
      { name: 'IsOught', args: ['good'] },
    ],
    relations: [
      { predicate: 'remains', from: 'good', to: 'ought' },
      { predicate: 'is', from: 'fulfilledGood', to: 'absolutePostulate' },
    ],
  },
  {
    id: 'cognition-op-b-3-transition',
    chunkId: 'cognition-b-3-transition-absolute-idea',
    label: 'Transition to absolute idea',
    clauses: [
      'practicalIdea.lacks = momentOfRealConsciousness',
      'practicalIdea.lacks = momentOfTheoreticalIdea',
      'will.separatesFrom = cognition',
      'good.findsCompletionIn = true',
      'transitionThroughItself = true',
      'firstPremise = immediateReference',
      'secondPremise = externalMeans',
      'abstractBeing.sublatedBy = practicalIdea',
      'firstPremise = immediateObjectivity',
      'purpose.communicatedWithoutResistance = true',
      'secondPremise = mediation',
      'realization = necessaryMediation',
      'firstPremise = firstNegation',
      'secondPremise = sublationOfOtherness',
      'actualityOfGood = conceptExistingForItself',
      'conceptExistingForItself = freeConcept',
      'presupposition.sublated = true',
      'mediation.sublated = true',
      'result = immediacy',
      'idea = immediateActuality',
      'actuality = objectivityTrulyExists',
      'subject = freeUniversalSelfIdentity',
      'objectivity = given',
      'cognition.restored = true',
      'cognition.unitedWith = practicalIdea',
      'reality = realizedAbsolutePurpose',
      'objectiveWorld.innerGround = concept',
      'objectiveWorld.actualSubsistence = concept',
      'this = absoluteIdea',
    ],
    predicates: [
      { name: 'IsAbsoluteIdea', args: ['objectiveWorldWithConcept'] },
      { name: 'IsFreeConcept', args: ['conceptExistingForItself'] },
    ],
    relations: [
      { predicate: 'transitionsTo', from: 'good', to: 'absoluteIdea' },
      { predicate: 'is', from: 'objectiveWorldWithConcept', to: 'absoluteIdea' },
    ],
  },
];
