...
the determinate determinate.`,
    summary: 'Singularity flows from particularity: determinate universality → self-referring determinateness.'
  },
  {
...
and where it is posited as concept.`,
    summary: 'Singularity = self-mediation (negation of negation). Inward/outward shine: abstraction climbs to empty genera (false), while true singularity is the depth where concept posits itself.'
  },
  {
...
void of spirit, color, and content.`,
    summary: 'U and P are the total concept; in S they are what they are in-and-for-themselves. Abstraction drops determinateness and excludes singularity, yielding lifeless universals.'
  },
  {
...
the opposite of what it is supposed to be.`,
    summary: 'Abstraction isolates determinations and yields singular products (content/form split), yet these are concrete unities of singular content and abstract universality.'
  },
  {
...
and be counted with them.`,
    summary: 'P ↔ S as determinate universals. If kept abstract, concept has three particular determinations (U, P, S).'
  },
  {
...
the middle term of the formal syllogism.`,
    summary: 'Treating S as one determination: particularity = embracing totality (concretion), also immediate unity (as determinate universality) → middle term of formal syllogism.'
  },
  {
...
and nowhere is such a distinction as inappropriate as here.`,
    summary: 'Determinations dissolve into each other; only representational thinking isolates and “counts” U/P/S. Quantitative distinction is misplaced here.'
  },
  {
...
in its determinateness the whole concept.`,
    summary: 'S posits inseparability: as negation of negation, it grounds opposition in unity. Each distinct determination is the totality; determinateness is the whole concept.'
  },
  {
...
is now posited abstraction.`,
    summary: 'Singularity makes the concept actual: as immanent abstraction it concretizes U and P into content; fixes difference as determinate determinateness (posited abstraction).'
  },
  {
...
to the latter as a mere commonality.`,
    summary: 'Singular = qualitative this: repulsion presupposes many; exclusive toward others. Universal taken as mere commonality of indifferent singulars is the lowest, external view.'
  },
  {
...
yet is, precisely in its separation, a positive connection.`,
    summary: '“This” is posited immediacy via external pointing. The singular is also a this, but its mediation is internal: self-separating abstraction that is simultaneously positive connection.'
  },
  {
...
it refers to it just as essentially.`,
    summary: 'Singularity posits self-subsisting differences in essential relation (not mere plurality). It excludes the universal yet refers to it as an essential moment.'
  },
  {
...
that is, as singularity it is posited as judgment.`,
    summary: 'Self-subsistent determinations mean the concept loses its posited unity; the determinate becomes totality. Turning-back as singularity = absolute, originative partition → judgment.'
  }
]
