// Neo4j Query Pack — Integrated Actuality/Absolute IR
// IR: integrated-actuality-absolute-topicmap-ir
// Generated for section: Doctrine of Essence / Actuality / Absolute
...
MATCH (c:IntegratedChunk {id: 'mod-9'})-[:HAS_KEY_POINT]->(k:KeyPoint)
