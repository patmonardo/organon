// Neo4j Query Pack — Integrated Actuality/Actuality IR
// IR: integrated-actuality-actuality-topicmap-ir
...
MATCH (c:IntegratedChunk {id: 'act-c-11'})-[:HAS_KEY_POINT]->(k:KeyPoint)
