  ...
  "moments": [
    {
      ...
      "definition": "Finite causality appears as external transposition between substances",
      "type": "externality"
    },
    {
      "name": "reciprocity",
      "definition": "Reciprocity sublates mechanism through mediated originariness",
      "type": "sublation",
      "relation": "negates",
...
const stateSubC3: DialecticState = {
  ...
  "forces": [
    {
      "id": "sub-c-3-force-1",
      "description": "Reciprocity differentiates into universal, singular, particular",
      "type": "sublation",
...
export const reciprocityActionIR: DialecticIR = {
  ...
  section: "ESSENCE - C. ACTUALITY - Absolute Relation - c. Reciprocity of Action",
  states: [
    stateSubC1,
    stateSubC3,
    stateSubC5,
