// Neo4j Query Pack — Integrated Actuality/Substance IR
// IR: integrated-actuality-substance-topicmap-ir
// Generated for section: Doctrine of Essence / Actuality / Substance
...
MATCH (c:IntegratedChunk {id: 'sub-c-5'})-[:HAS_KEY_POINT]->(k:KeyPoint)
