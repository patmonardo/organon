...
MERGE (ir:IntegratedIR {id: 'integrated-appearance-relation-topicmap-ir'}) SET ir.mode = 'debug', ir.title = 'Integrated Appearance-Relation TopicMap IR', ir.section = 'Doctrine of Essence / Appearance / Relation', ir.generatedAt = '2026-02-17T17:41:22.685Z', ir.totalSources = 3, ir.totalChunks = 29;

MERGE (s:SourceText {id: 'source-whole-parts'})
SET s.title = 'a. WHOLE AND PARTS'
SET s.sourceFile = 'relative/essence/appearance/relation/sources/whole-parts.txt'
SET s.totalLines = 263;
MATCH (ir:IntegratedIR {id: 'integrated-appearance-relation-topicmap-ir'})
MATCH (s:SourceText {id: 'source-whole-parts'})
MERGE (ir)-[:HAS_SOURCE]->(s);
MERGE (c:IntegratedChunk {id: 'wlp-1'})
SET c.title = 'Essential relation — two sides'
SET c.sourceId = 'source-whole-parts'
SET c.sourceFile = 'relative/essence/appearance/relation/sources/whole-parts.txt'
SET c.lineStart = 4
SET c.lineEnd = 50
SET c.description = 'Essential relation contains self-subsistence of concrete existence reflected into itself. Simple form whose determinations are concrete existences, posited at same time, moments held in unity. Self-subsistence reflected into itself is reflection into opposite, immediate self-subsistence. Subsistence is identity with opposite no less than own self-subsistence. Other side immediately posited: immediate self-subsistence determined as other, multifarious manifold. Manifold essentially has reference of other side, unity of reflected self-subsistence. Whole is self-subsistence that constitutes world existing in-and-for-itself. Parts is immediate concrete existence which was world of appearance. In relation, two sides are self-subsistences, each has other reflectively shining in it, only is as identity of both. Whole constitutes unity of two sides, substrate. Immediate concrete existence as positedness. On side of parts, immediate manifold is self-subsistent substrate, whole only external reference.'
SET c.keyPoints = ['Essential relation contains self-subsistence reflected into itself', 'Whole is world-in-itself, parts is world of appearance', 'Each has other reflectively shining in it', 'Whole is substrate, parts is self-subsistent substrate']
SET c.tags = ['reflection', 'mediation', 'appearance', 'relation', 'whole-parts']
SET c.orderInSource = 1
SET c.globalOrder = 1
SET c.sourceText = 'First, the essential relation contains the self-subsistence\nof concrete existence reflected into itself;\nit is then the simple form whose determinations are\nindeed also concrete existences,\nbut they are posited at the same time,\nmoments held in the unity.\nThis self-subsistence reflected into itself is\nat the same time reflection into its opposite,\nnamely the immediate self-subsistence,\nand its subsistence is this identity with its opposite\nno less than its own self-subsistence.\nSecond, the other side is\nthereby also immediately posited.\nThis is the immediate self-subsistence\nwhich, determined as the other,\nis in itself a multifarious manifold,\nbut in such a way that this manifold also essentially\nhas within it the reference of the other side,\nthe unity of the reflected self-subsistence.\nThat one side, the whole, is the self-subsistence\nthat constitutes the world existing in and for itself;\nthe other side, the parts,\nis the immediate concrete existence\nwhich was the world of appearance.\nIn the relation of whole and parts,\nthe two sides are these self-subsistences\nbut in such a way that each has the other\nreflectively shining in it\nand, at the same time, only is as the identity of both.\nNow because the essential relation is\nat first only the first, immediate relation,\nthe negative unity and the positive self-subsistence\nare bound together by the “also”;\nthe two sides are indeed both posited as moments,\nbut equally so as concretely existing self-subsistences.\nTheir being posited as moments is henceforth so distributed\nthat the whole, the reflected self-subsistence, is\nas concrete self-existent first,\nand the other, the immediate, is in it as a moment.\nThe whole constitutes here the\nunity of the two sides, the substrate,\nand the immediate concrete existence is as positedness.\nConversely, on the other side which is the side of the parts,\nthe immediate and internally manifold concrete existence is\nthe self-subsistent substrate;\nthe reflected unity, the whole,\nis on the contrary only external reference.';
MATCH (s:SourceText {id: 'source-whole-parts'})
MATCH (c:IntegratedChunk {id: 'wlp-1'})
MERGE (s)-[:HAS_CHUNK]->(c);
MERGE (kp:KeyPoint {id: 'wlp-1:kp:1'})
SET kp.chunkId = 'wlp-1'
SET kp.ordinal = 1
SET kp.text = 'Essential relation contains self-subsistence reflected into itself';
MATCH (c:IntegratedChunk {id: 'wlp-1'})
MATCH (kp:KeyPoint {id: 'wlp-1:kp:1'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'wlp-1:kp:2'})
SET kp.chunkId = 'wlp-1'
SET kp.ordinal = 2
SET kp.text = 'Whole is world-in-itself, parts is world of appearance';
MATCH (c:IntegratedChunk {id: 'wlp-1'})
MATCH (kp:KeyPoint {id: 'wlp-1:kp:2'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'wlp-1:kp:3'})
SET kp.chunkId = 'wlp-1'
SET kp.ordinal = 3
SET kp.text = 'Each has other reflectively shining in it';
MATCH (c:IntegratedChunk {id: 'wlp-1'})
MATCH (kp:KeyPoint {id: 'wlp-1:kp:3'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'wlp-1:kp:4'})
SET kp.chunkId = 'wlp-1'
SET kp.ordinal = 4
SET kp.text = 'Whole is substrate, parts is self-subsistent substrate';
MATCH (c:IntegratedChunk {id: 'wlp-1'})
MATCH (kp:KeyPoint {id: 'wlp-1:kp:4'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (c:IntegratedChunk {id: 'wlp-2'})
SET c.title = 'Relation contains contradiction'
SET c.sourceId = 'source-whole-parts'
SET c.sourceFile = 'relative/essence/appearance/relation/sources/whole-parts.txt'
SET c.lineStart = 52
SET c.lineEnd = 63
SET c.description = 'Relation contains self-subsistence of sides and their sublatedness no less, two simply in one reference. Whole is self-subsistent. Parts are only moments of unity, but also equally self-subsistent. Reflected unity only moment. Each, in self-subsistence, simply relative of other. Relation within it immediate contradiction, sublates itself.'
SET c.keyPoints = ['Contains self-subsistence and sublatedness', 'Each is relative of other', 'Immediate contradiction, sublates itself']
SET c.tags = ['sublation', 'reflection', 'mediation', 'relation', 'whole-parts']
SET c.orderInSource = 2
SET c.globalOrder = 2
SET c.sourceText = '2. This relation thus contains\nthe self-subsistence of the sides,\nand their sublatedness no less,\nand the two simply in one reference.\nThe whole is the self-subsistent;\nthe parts are only moments of this unity,\nbut they are also equally self-subsistent\nand their reflected unity is only a moment;\nand each is, in its self-subsistence,\nsimply the relative of an other.\nThis relation is within it, therefore,\nimmediate contradiction, and it sublates itself.';
MATCH (s:SourceText {id: 'source-whole-parts'})
MATCH (c:IntegratedChunk {id: 'wlp-2'})
MERGE (s)-[:HAS_CHUNK]->(c);
MERGE (kp:KeyPoint {id: 'wlp-2:kp:1'})
SET kp.chunkId = 'wlp-2'
SET kp.ordinal = 1
SET kp.text = 'Contains self-subsistence and sublatedness';
MATCH (c:IntegratedChunk {id: 'wlp-2'})
MATCH (kp:KeyPoint {id: 'wlp-2:kp:1'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'wlp-2:kp:2'})
SET kp.chunkId = 'wlp-2'
SET kp.ordinal = 2
SET kp.text = 'Each is relative of other';
MATCH (c:IntegratedChunk {id: 'wlp-2'})
MATCH (kp:KeyPoint {id: 'wlp-2:kp:2'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'wlp-2:kp:3'})
SET kp.chunkId = 'wlp-2'
SET kp.ordinal = 3
SET kp.text = 'Immediate contradiction, sublates itself';
MATCH (c:IntegratedChunk {id: 'wlp-2'})
MATCH (kp:KeyPoint {id: 'wlp-2:kp:3'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (c:IntegratedChunk {id: 'wlp-3'})
SET c.title = 'Whole — self-externalized'
SET c.sourceId = 'source-whole-parts'
SET c.sourceFile = 'relative/essence/appearance/relation/sources/whole-parts.txt'
SET c.lineStart = 65
SET c.lineEnd = 82
SET c.description = 'Whole is reflected unity that stands independently on own. But subsistence equally repelled by it. Self-externalized. Has subsistence in opposite, manifold immediacy, parts. Whole consists of parts, apart from them not anything. Whole relation and self-subsistent totality. But for precisely this reason, only relative. What makes it totality is rather other, parts. Does not have subsistence within it but in other.'
SET c.keyPoints = ['Whole self-externalized, has subsistence in parts', 'Consists of parts, apart from them not anything', 'Only relative, subsistence in other']
SET c.tags = ['reflection', 'relation', 'whole-parts']
SET c.orderInSource = 3
SET c.globalOrder = 3
SET c.sourceText = 'On closer inspection,\nthe whole is the reflected unity\nthat stands independently on its own;\nbut this subsistence that belongs to it\nis equally repelled by it;\nit is thus self-externalized;\nit has its subsistence in its opposite,\nin the manifold immediacy, the parts.\nThe whole thus consists of the parts,\nand apart from them it is not anything.\nIt is therefore the whole relation\nand the self-subsistent totality,\nbut, for precisely this reason,\nit is only a relative,\nfor what makes it a totality is\nrather its other, the parts;\nit does not have its subsistence\nwithin it but in its other.';
MATCH (s:SourceText {id: 'source-whole-parts'})
MATCH (c:IntegratedChunk {id: 'wlp-3'})
MERGE (s)-[:HAS_CHUNK]->(c);
MERGE (kp:KeyPoint {id: 'wlp-3:kp:1'})
SET kp.chunkId = 'wlp-3'
SET kp.ordinal = 1
SET kp.text = 'Whole self-externalized, has subsistence in parts';
MATCH (c:IntegratedChunk {id: 'wlp-3'})
MATCH (kp:KeyPoint {id: 'wlp-3:kp:1'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'wlp-3:kp:2'})
SET kp.chunkId = 'wlp-3'
SET kp.ordinal = 2
SET kp.text = 'Consists of parts, apart from them not anything';
MATCH (c:IntegratedChunk {id: 'wlp-3'})
MATCH (kp:KeyPoint {id: 'wlp-3:kp:2'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'wlp-3:kp:3'})
SET kp.chunkId = 'wlp-3'
SET kp.ordinal = 3
SET kp.text = 'Only relative, subsistence in other';
MATCH (c:IntegratedChunk {id: 'wlp-3'})
MATCH (kp:KeyPoint {id: 'wlp-3:kp:3'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (c:IntegratedChunk {id: 'wlp-4'})
SET c.title = 'Parts — whole relation'
SET c.sourceId = 'source-whole-parts'
SET c.sourceFile = 'relative/essence/appearance/relation/sources/whole-parts.txt'
SET c.lineStart = 84
SET c.lineEnd = 106
SET c.description = 'Parts likewise whole relation. Immediate as against reflected self-subsistence. Do not subsist in whole but for themselves. Have whole within them as moment. Whole constitutes connecting reference. Without whole no parts. But because self-subsistent, connection only external moment, with respect to which indifferent. But parts, as manifold concrete existence, collapse together. Concrete existence is reflectionless being. Have self-subsistence only in reflected unity, which is unity as well as concrete existent manifoldness. Have self-subsistence only in whole. But whole at same time self-subsistence which is other to parts.'
SET c.keyPoints = ['Parts have whole within them as moment', 'Without whole no parts', 'Have self-subsistence only in whole', 'Whole is other to parts']
SET c.tags = ['reflection', 'mediation', 'relation', 'whole-parts']
SET c.orderInSource = 4
SET c.globalOrder = 4
SET c.sourceText = 'The parts, too, are likewise the whole relation.\nThey are the immediate as against\nthe reflected self-subsistence,\nand do not subsist in the whole\nbut are for themselves.\nFurther, they have this whole within them as their moment;\nthe whole constitutes their connecting reference;\nwithout the whole there are no parts.\nBut because they are the self-subsistent,\nthis connection is only an external moment\nwith respect to which they are\nin and for themselves indifferent.\nBut at the same time the parts,\nas manifold concrete existence, collapse together,\nfor this concrete existence is reflectionless being;\nthey have their self-subsistence\nonly in the reflected unity\nwhich is this unity as well as\nthe concrete existent manifoldness;\nthis means that they have\nself-subsistence only in the whole,\nbut this whole is at the same time the\nself-subsistence which is the other to the parts.';
MATCH (s:SourceText {id: 'source-whole-parts'})
MATCH (c:IntegratedChunk {id: 'wlp-4'})
MERGE (s)-[:HAS_CHUNK]->(c);
MERGE (kp:KeyPoint {id: 'wlp-4:kp:1'})
SET kp.chunkId = 'wlp-4'
SET kp.ordinal = 1
SET kp.text = 'Parts have whole within them as moment';
MATCH (c:IntegratedChunk {id: 'wlp-4'})
MATCH (kp:KeyPoint {id: 'wlp-4:kp:1'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'wlp-4:kp:2'})
SET kp.chunkId = 'wlp-4'
SET kp.ordinal = 2
SET kp.text = 'Without whole no parts';
MATCH (c:IntegratedChunk {id: 'wlp-4'})
MATCH (kp:KeyPoint {id: 'wlp-4:kp:2'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'wlp-4:kp:3'})
SET kp.chunkId = 'wlp-4'
SET kp.ordinal = 3
SET kp.text = 'Have self-subsistence only in whole';
MATCH (c:IntegratedChunk {id: 'wlp-4'})
MATCH (kp:KeyPoint {id: 'wlp-4:kp:3'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'wlp-4:kp:4'})
SET kp.chunkId = 'wlp-4'
SET kp.ordinal = 4
SET kp.text = 'Whole is other to parts';
MATCH (c:IntegratedChunk {id: 'wlp-4'})
MATCH (kp:KeyPoint {id: 'wlp-4:kp:4'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (c:IntegratedChunk {id: 'wlp-5'})
SET c.title = 'Reciprocal conditioning — unconditioned'
SET c.sourceId = 'source-whole-parts'
SET c.sourceFile = 'relative/essence/appearance/relation/sources/whole-parts.txt'
SET c.lineStart = 108
SET c.lineEnd = 131
SET c.description = 'Whole and parts reciprocally condition each other. Relation higher than reference of conditioned and condition. Reference realized: condition is essential self-subsistence of conditioned, presupposed by latter. Condition as such only immediate, implicitly presupposed. Whole, through condition of parts, entails it only in so far as has parts for presupposition. Both sides posited as conditioning each other reciprocally. Each immediate self-subsistence, but self-subsistence equally mediated or posited through other. Whole relation, because of reciprocity, is turning back of conditioning into itself, non-relative, unconditioned.'
SET c.keyPoints = ['Reciprocally condition each other', 'Each immediate self-subsistence, equally mediated through other', 'Turning back of conditioning into itself, unconditioned']
SET c.tags = ['mediation', 'relation', 'whole-parts']
SET c.orderInSource = 5
SET c.globalOrder = 5
SET c.sourceText = 'The whole and the parts thus\nreciprocally condition each other;\nbut the relation here considered is\nat the same time higher than the\nreference of conditioned and condition\nto each other as earlier determined.\nHere this reference is realized, that is to say,\nit is posited that the condition is\nthe essential self-subsistence of the conditioned\nin such a manner that it is presupposed by the latter.\nThe condition as such is only the immediate,\nand it is only implicitly presupposed.\nBut the whole, through the condition of the parts,\nitself immediately entails that it, too,\nis only in so far as it has\nthe parts for presupposition.\nThus, since both sides of the relation\nare posited as conditioning each other reciprocally,\neach is on its own an immediate self-subsistence,\nbut their self-subsistence is equally\nmediated or posited through the other.\nThe whole relation, because of this reciprocity,\nis the turning back of the conditioning into itself,\nthe non-relative, the unconditioned.';
MATCH (s:SourceText {id: 'source-whole-parts'})
MATCH (c:IntegratedChunk {id: 'wlp-5'})
MERGE (s)-[:HAS_CHUNK]->(c);
MERGE (kp:KeyPoint {id: 'wlp-5:kp:1'})
SET kp.chunkId = 'wlp-5'
SET kp.ordinal = 1
SET kp.text = 'Reciprocally condition each other';
MATCH (c:IntegratedChunk {id: 'wlp-5'})
MATCH (kp:KeyPoint {id: 'wlp-5:kp:1'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'wlp-5:kp:2'})
SET kp.chunkId = 'wlp-5'
SET kp.ordinal = 2
SET kp.text = 'Each immediate self-subsistence, equally mediated through other';
MATCH (c:IntegratedChunk {id: 'wlp-5'})
MATCH (kp:KeyPoint {id: 'wlp-5:kp:2'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'wlp-5:kp:3'})
SET kp.chunkId = 'wlp-5'
SET kp.ordinal = 3
SET kp.text = 'Turning back of conditioning into itself, unconditioned';
MATCH (c:IntegratedChunk {id: 'wlp-5'})
MATCH (kp:KeyPoint {id: 'wlp-5:kp:3'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (c:IntegratedChunk {id: 'wlp-6'})
SET c.title = 'Two respects — identity and indifference'
SET c.sourceId = 'source-whole-parts'
SET c.sourceFile = 'relative/essence/appearance/relation/sources/whole-parts.txt'
SET c.lineStart = 133
SET c.lineEnd = 139
SET c.description = 'Inasmuch as each side has self-subsistence not in it but in other, only one identity of two in which both only moments. But inasmuch as each self-subsistent on own, two are two self-subsistent concrete existences indifferent to each other.'
SET c.keyPoints = ['One identity in which both only moments', 'Two self-subsistent concrete existences indifferent to each other']
SET c.tags = []
SET c.orderInSource = 6
SET c.globalOrder = 6
SET c.sourceText = 'Now inasmuch as each side of the relation has\nits self-subsistence not in it but in its other,\nwhat we have is only one identity of the two\nin which they are both only moments;\nbut inasmuch as each is self-subsistent on its own,\nthe two are two self-subsistent concrete existences\nindifferent to each other.';
MATCH (s:SourceText {id: 'source-whole-parts'})
MATCH (c:IntegratedChunk {id: 'wlp-6'})
MERGE (s)-[:HAS_CHUNK]->(c);
MERGE (kp:KeyPoint {id: 'wlp-6:kp:1'})
SET kp.chunkId = 'wlp-6'
SET kp.ordinal = 1
SET kp.text = 'One identity in which both only moments';
MATCH (c:IntegratedChunk {id: 'wlp-6'})
MATCH (kp:KeyPoint {id: 'wlp-6:kp:1'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'wlp-6:kp:2'})
SET kp.chunkId = 'wlp-6'
SET kp.ordinal = 2
SET kp.text = 'Two self-subsistent concrete existences indifferent to each other';
MATCH (c:IntegratedChunk {id: 'wlp-6'})
MATCH (kp:KeyPoint {id: 'wlp-6:kp:2'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (c:IntegratedChunk {id: 'wlp-7'})
SET c.title = 'Essential identity — equality'
SET c.sourceId = 'source-whole-parts'
SET c.sourceFile = 'relative/essence/appearance/relation/sources/whole-parts.txt'
SET c.lineStart = 141
SET c.lineEnd = 153
SET c.description = 'In first respect, essential identity of two sides. Whole equal to parts and parts equal to whole. Nothing in whole which is not in parts, nothing in parts which is not in whole. Whole not abstract unity but unity of diversified manifoldness. Unity within which manifold held together is determinateness by virtue of which latter is parts. Relation has indivisible identity and only one self-subsistence.'
SET c.keyPoints = ['Whole equal to parts, parts equal to whole', 'Nothing in whole not in parts, nothing in parts not in whole', 'Indivisible identity, only one self-subsistence']
SET c.tags = ['relation', 'whole-parts']
SET c.orderInSource = 7
SET c.globalOrder = 7
SET c.sourceText = 'In the first respect, that of\nthe essential identity of the two sides,\nthe whole is equal to the parts\nand the parts are equal to the whole.\nNothing is in the whole which is not in the parts,\nand nothing is in the parts which is not in the whole.\nThe whole is not an abstract unity\nbut the unity of a diversified manifoldness;\nbut this unity within which the manifold is\nheld together is the determinateness\nby virtue of which the latter is the parts.\nThe relation has, therefore, an indivisible identity\nand only one self-subsistence.';
MATCH (s:SourceText {id: 'source-whole-parts'})
MATCH (c:IntegratedChunk {id: 'wlp-7'})
MERGE (s)-[:HAS_CHUNK]->(c);
MERGE (kp:KeyPoint {id: 'wlp-7:kp:1'})
SET kp.chunkId = 'wlp-7'
SET kp.ordinal = 1
SET kp.text = 'Whole equal to parts, parts equal to whole';
MATCH (c:IntegratedChunk {id: 'wlp-7'})
MATCH (kp:KeyPoint {id: 'wlp-7:kp:1'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'wlp-7:kp:2'})
SET kp.chunkId = 'wlp-7'
SET kp.ordinal = 2
SET kp.text = 'Nothing in whole not in parts, nothing in parts not in whole';
MATCH (c:IntegratedChunk {id: 'wlp-7'})
MATCH (kp:KeyPoint {id: 'wlp-7:kp:2'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'wlp-7:kp:3'})
SET kp.chunkId = 'wlp-7'
SET kp.ordinal = 3
SET kp.text = 'Indivisible identity, only one self-subsistence';
MATCH (c:IntegratedChunk {id: 'wlp-7'})
MATCH (kp:KeyPoint {id: 'wlp-7:kp:3'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (c:IntegratedChunk {id: 'wlp-8'})
SET c.title = 'Whole equal to parts — tautology'
SET c.sourceId = 'source-whole-parts'
SET c.sourceFile = 'relative/essence/appearance/relation/sources/whole-parts.txt'
SET c.lineStart = 155
SET c.lineEnd = 173
SET c.description = 'Whole equal to parts but not to them as parts. Whole is reflected unity. Parts constitute determinate moment or otherness of unity, diversified manifold. Whole not equal to them as self-subsistent diversity but to them together. Their \'together\' nothing else but unity, whole as such. In parts, whole only equal to itself. Equality expresses only tautology: whole as whole equal not to parts but to whole.'
SET c.keyPoints = ['Whole equal to parts but not as parts', 'Equal to them together, which is whole', 'Tautology: whole equal to whole']
SET c.tags = ['reflection', 'whole-parts']
SET c.orderInSource = 8
SET c.globalOrder = 8
SET c.sourceText = 'But further, the whole is equal to the parts\nbut not to them as parts;\nthe whole is the reflected unity\nwhereas the parts constitute\nthe determinate moment\nor the otherness of the unity\nand are the diversified manifold.\nThe whole is not equal to them\nas this self-subsistent diversity\nbut to them together.\nBut this, their “together,” is\nnothing else but their unity,\nthe whole as such.\nIn the parts, therefore, the whole\nis only equal to itself,\nand the equality of it and the parts expresses\nonly this tautology,\nnamely that the whole as whole is equal\nnot to the parts but to the whole.';
MATCH (s:SourceText {id: 'source-whole-parts'})
MATCH (c:IntegratedChunk {id: 'wlp-8'})
MERGE (s)-[:HAS_CHUNK]->(c);
MERGE (kp:KeyPoint {id: 'wlp-8:kp:1'})
SET kp.chunkId = 'wlp-8'
SET kp.ordinal = 1
SET kp.text = 'Whole equal to parts but not as parts';
MATCH (c:IntegratedChunk {id: 'wlp-8'})
MATCH (kp:KeyPoint {id: 'wlp-8:kp:1'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'wlp-8:kp:2'})
SET kp.chunkId = 'wlp-8'
SET kp.ordinal = 2
SET kp.text = 'Equal to them together, which is whole';
MATCH (c:IntegratedChunk {id: 'wlp-8'})
MATCH (kp:KeyPoint {id: 'wlp-8:kp:2'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'wlp-8:kp:3'})
SET kp.chunkId = 'wlp-8'
SET kp.ordinal = 3
SET kp.text = 'Tautology: whole equal to whole';
MATCH (c:IntegratedChunk {id: 'wlp-8'})
MATCH (kp:KeyPoint {id: 'wlp-8:kp:3'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (c:IntegratedChunk {id: 'wlp-9'})
SET c.title = 'Parts equal to whole — tautology'
SET c.sourceId = 'source-whole-parts'
SET c.sourceFile = 'relative/essence/appearance/relation/sources/whole-parts.txt'
SET c.lineStart = 175
SET c.lineEnd = 187
SET c.description = 'Parts equal to whole. But because, as parts, moment of otherness, not equal to it as unity. But one of whole\'s manifold determinations maps over part. Equal to whole as manifold, as apportioned whole, as parts. Same tautology: parts as parts equal not to whole as such but in whole, to themselves.'
SET c.keyPoints = ['Parts equal to whole as manifold', 'Equal as apportioned whole, as parts', 'Tautology: parts equal to themselves']
SET c.tags = ['whole-parts']
SET c.orderInSource = 9
SET c.globalOrder = 9
SET c.sourceText = 'Conversely, the parts are equal to the whole;\nbut because, as parts,\nthey are the moment of otherness,\nthey are not equal to it as the unity,\nbut in such a way that one of the whole\'s\nmanifold determinations maps over a part,\nor that they are equal to the whole as manifold,\nand this is to say that they are equal to it\nas an apportioned whole, that is, as parts.\nHere we thus have the same tautology,\nthat the parts as parts are equal\nnot to the whole as such\nbut, in the whole, to themselves.';
MATCH (s:SourceText {id: 'source-whole-parts'})
MATCH (c:IntegratedChunk {id: 'wlp-9'})
MERGE (s)-[:HAS_CHUNK]->(c);
MERGE (kp:KeyPoint {id: 'wlp-9:kp:1'})
SET kp.chunkId = 'wlp-9'
SET kp.ordinal = 1
SET kp.text = 'Parts equal to whole as manifold';
MATCH (c:IntegratedChunk {id: 'wlp-9'})
MATCH (kp:KeyPoint {id: 'wlp-9:kp:1'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'wlp-9:kp:2'})
SET kp.chunkId = 'wlp-9'
SET kp.ordinal = 2
SET kp.text = 'Equal as apportioned whole, as parts';
MATCH (c:IntegratedChunk {id: 'wlp-9'})
MATCH (kp:KeyPoint {id: 'wlp-9:kp:2'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'wlp-9:kp:3'})
SET kp.chunkId = 'wlp-9'
SET kp.ordinal = 3
SET kp.text = 'Tautology: parts equal to themselves';
MATCH (c:IntegratedChunk {id: 'wlp-9'})
MATCH (kp:KeyPoint {id: 'wlp-9:kp:3'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (c:IntegratedChunk {id: 'wlp-10'})
SET c.title = 'Fall apart — destroy themselves'
SET c.sourceId = 'source-whole-parts'
SET c.sourceFile = 'relative/essence/appearance/relation/sources/whole-parts.txt'
SET c.lineStart = 189
SET c.lineEnd = 221
SET c.description = 'Whole and parts fall indifferently apart. Each side refers only to itself. As held apart, destroy themselves. Whole indifferent towards parts is abstract identity, undifferentiated in itself. Identity whole only inasmuch as differentiated in itself. Identity of reflection has shown through movement that it has reflection into other for truth. Parts, indifferent to unity, only unconnected manifold, inherently other which sublates itself. Self-reference of each side is self-subsistence. But self-subsistence each side has for itself is negation of respective selves. Each side has self-subsistence not within but in other side. Other constitutes subsistence, presupposed immediate, supposed to be first. But first of each side only first which is not first, has beginning in other.'
SET c.keyPoints = ['Fall apart, destroy themselves', 'Self-subsistence each has for itself is negation of selves', 'Each has self-subsistence in other', 'First which is not first, has beginning in other']
SET c.tags = ['negation', 'sublation', 'reflection', 'mediation', 'whole-parts']
