// Neo4j Query Pack — Appearance/Relation IR
// IR: appearance-relation-topicmap-ir
// Generated for section: Doctrine of Essence / Appearance / Relation
...
MATCH (c:TopicMapChunk {id: 'oin-5'})-[:HAS_KEY_POINT]->(k:KeyPoint)
