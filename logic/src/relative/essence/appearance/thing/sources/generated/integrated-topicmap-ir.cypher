...
// Generated by src/tools/generate-appearance-thing-ir.ts
...
SET c.keyPoints = ['Thing progressed from indeterminacy to determinateness', 'Through property continuous with other things', 'Imperfect distinction sublated', 'Thing determined in itself, is this thing']
SET c.tags = ['negation', 'sublation', 'thing', 'property']
SET c.orderInSource = 4
SET c.globalOrder = 23
SET c.sourceText = 'Second, the thing has thereby progressed\nfrom its indeterminacy to full determinateness.\nAs thing in itself, it is abstract identity,\nsimple negative concrete existence,\nor this concrete existence\ndetermined as the indeterminate;\nit is then determined through its properties,\nby virtue of which it is supposed to be\ndistinguished from other things;\nbut, since through the property the thing is\nrather continuous with other things,\nthis imperfect distinction is sublated;\nthe thing has thereby returned into itself\nand is now determined as determined;\nit is determined in itself or is this thing.';
MATCH (s:SourceText {id: 'source-matter'})
MATCH (c:IntegratedChunk {id: 'mat-4'})
MERGE (s)-[:HAS_CHUNK]->(c);
MERGE (kp:KeyPoint {id: 'mat-4:kp:1'})
SET kp.chunkId = 'mat-4'
SET kp.ordinal = 1
SET kp.text = 'Thing progressed from indeterminacy to determinateness';
MATCH (c:IntegratedChunk {id: 'mat-4'})
MATCH (kp:KeyPoint {id: 'mat-4:kp:1'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'mat-4:kp:2'})
SET kp.chunkId = 'mat-4'
SET kp.ordinal = 2
SET kp.text = 'Through property continuous with other things';
MATCH (c:IntegratedChunk {id: 'mat-4'})
MATCH (kp:KeyPoint {id: 'mat-4:kp:2'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'mat-4:kp:3'})
SET kp.chunkId = 'mat-4'
SET kp.ordinal = 3
SET kp.text = 'Imperfect distinction sublated';
MATCH (c:IntegratedChunk {id: 'mat-4'})
MATCH (kp:KeyPoint {id: 'mat-4:kp:3'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'mat-4:kp:4'})
SET kp.chunkId = 'mat-4'
SET kp.ordinal = 4
SET kp.text = 'Thing determined in itself, is this thing';
MATCH (c:IntegratedChunk {id: 'mat-4'})
MATCH (kp:KeyPoint {id: 'mat-4:kp:4'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (c:IntegratedChunk {id: 'mat-5'})
SET c.title = 'Third — turning back unessential'
SET c.sourceId = 'source-matter'
SET c.sourceFile = 'relative/essence/appearance/thing/sources/matter.txt'
SET c.lineStart = 73
SET c.lineEnd = 84
...
SET c.keyPoints = ['Turning back unessential determination', 'Self-continuous subsistence makes up self-subsistent matter', 'Difference of things sublated, external', 'Complete determinateness in element of inessentiality']
SET c.tags = ['sublation', 'thing', 'matter']
SET c.orderInSource = 5
SET c.globalOrder = 24
SET c.sourceText = 'But, third, this turning back into itself,\nthough a self-referring determination,\nis at the same time an unessential determination;\nthe self-continuous subsistence makes up\nthe self-subsistent matter\nin which the difference of things,\ntheir determinateness existing in and for itself,\nis sublated and is something external.\nTherefore, although the thing as this thing\nis complete determinateness,\nthis determinateness is such\nin the element of inessentiality.';
MATCH (s:SourceText {id: 'source-matter'})
MATCH (c:IntegratedChunk {id: 'mat-5'})
MERGE (s)-[:HAS_CHUNK]->(c);
MERGE (kp:KeyPoint {id: 'mat-5:kp:1'})
SET kp.chunkId = 'mat-5'
SET kp.ordinal = 1
SET kp.text = 'Turning back unessential determination';
MATCH (c:IntegratedChunk {id: 'mat-5'})
MATCH (kp:KeyPoint {id: 'mat-5:kp:1'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'mat-5:kp:2'})
SET kp.chunkId = 'mat-5'
SET kp.ordinal = 2
SET kp.text = 'Self-continuous subsistence makes up self-subsistent matter';
MATCH (c:IntegratedChunk {id: 'mat-5'})
MATCH (kp:KeyPoint {id: 'mat-5:kp:2'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'mat-5:kp:3'})
SET kp.chunkId = 'mat-5'
SET kp.ordinal = 3
SET kp.text = 'Difference of things sublated, external';
MATCH (c:IntegratedChunk {id: 'mat-5'})
MATCH (kp:KeyPoint {id: 'mat-5:kp:3'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'mat-5:kp:4'})
SET kp.chunkId = 'mat-5'
SET kp.ordinal = 4
SET kp.text = 'Complete determinateness in element of inessentiality';
MATCH (c:IntegratedChunk {id: 'mat-5'})
MATCH (kp:KeyPoint {id: 'mat-5:kp:4'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (c:IntegratedChunk {id: 'mat-6'})
SET c.title = 'Movement of property — two moments'
SET c.sourceId = 'source-matter'
SET c.sourceFile = 'relative/essence/appearance/thing/sources/matter.txt'
SET c.lineStart = 86
SET c.lineEnd = 118
SET c.description = 'Property is not only external determination but concrete existence immediately existing in itself. Unity of externality and essentiality repels itself from itself, contains reflection-into-itself and reflection-into-other. On one hand, determination as simple, self-identical and self-referring self-subsistent in which negative unity, one of thing, is sublated. On other hand, determination over against other, but likewise as one reflected into itself and determined in itself. Therefore, matters and this thing. Two moments of self-identical externality, property reflected into itself. Property was that by which things supposed to be distinguished. Thing freed itself of negative side of inhering in other, become free from being determined by other things, returned into itself. At same time, only thing-in-itself now become other of itself. Manifold properties have become self-subsistent, negative connection in one of thing now only sublated connection. Thing is self-identical negation only as against positive continuity of material.'
SET c.keyPoints = ['Property is externality and essentiality, repels itself', 'Two moments: matters and this thing', 'Thing freed itself, returned into itself', 'Thing is self-identical negation against positive continuity of material']
SET c.tags = ['negation', 'sublation', 'reflection', 'mediation', 'thing', 'property', 'matter']
SET c.orderInSource = 6
SET c.globalOrder = 25
SET c.sourceText = 'Considered from the side of the movement of the property,\nthis result follows in this way.\nThe property is not only external determination\nbut concrete existence immediately existing in itself.\nThis unity of externality and essentiality repels itself from itself,\nfor it contains reflection-into-itself and reflection-into-other,\nand, on the one hand, it is determination as simple,\nself-identical and self-referring self-subsistent\nin which the negative unity,\nthe one of the thing, is sublated;\non the other hand, it is this determination over against an other,\nbut likewise as a one which is reflected into itself\nand is determined in itself;\nit is, therefore, the matters and this thing.\nThese are the two moments of self-identical externality,\nor of property reflected into itself.\nThe property was that by which things\nwere supposed to be distinguished.\nSince the thing has freed itself of its\nnegative side of inhering in an other,\nit has thereby also become free\nfrom its being determined by other things\nand has returned into itself\nfrom the reference connecting it to the other.\nAt the same time, however, it is only the thing-in-itself\nnow become the other of itself,\nfor the manifold properties on their part\nhave become self-subsistent\nand their negative connection\nin the one of the thing is\nnow only a sublated connection.\nConsequently, the thing is self-identical negation\nonly as against the positive continuity of the material.';
MATCH (s:SourceText {id: 'source-matter'})
MATCH (c:IntegratedChunk {id: 'mat-6'})
MERGE (s)-[:HAS_CHUNK]->(c);
MERGE (kp:KeyPoint {id: 'mat-6:kp:1'})
SET kp.chunkId = 'mat-6'
SET kp.ordinal = 1
SET kp.text = 'Property is externality and essentiality, repels itself';
MATCH (c:IntegratedChunk {id: 'mat-6'})
MATCH (kp:KeyPoint {id: 'mat-6:kp:1'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'mat-6:kp:2'})
SET kp.chunkId = 'mat-6'
SET kp.ordinal = 2
SET kp.text = 'Two moments: matters and this thing';
MATCH (c:IntegratedChunk {id: 'mat-6'})
MATCH (kp:KeyPoint {id: 'mat-6:kp:2'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'mat-6:kp:3'})
SET kp.chunkId = 'mat-6'
SET kp.ordinal = 3
SET kp.text = 'Thing freed itself, returned into itself';
MATCH (c:IntegratedChunk {id: 'mat-6'})
MATCH (kp:KeyPoint {id: 'mat-6:kp:3'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'mat-6:kp:4'})
SET kp.chunkId = 'mat-6'
SET kp.ordinal = 4
SET kp.text = 'Thing is self-identical negation against positive continuity of material';
MATCH (c:IntegratedChunk {id: 'mat-6'})
MATCH (kp:KeyPoint {id: 'mat-6:kp:4'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (c:IntegratedChunk {id: 'mat-7'})
SET c.title = '"This" — complete determinateness'
SET c.sourceId = 'source-matter'
SET c.sourceFile = 'relative/essence/appearance/thing/sources/matter.txt'
SET c.lineStart = 120
SET c.lineEnd = 152
SET c.description = '"This" constitutes complete determinateness of thing, determinateness which is at same time external determinateness. Thing consists of self-subsistent matters indifferent to connection they have in thing. Connection only unessential linking. Difference of one thing from another depends on more or less of particular matters and in what amount. Matters overrun this thing, continue into others. That they belong to this thing is no restriction for them. Just as little restriction for one another. Negative connection only impotent "this." In being linked together, do not sublate themselves. Self-subsistent, impenetrable to each other. In determinateness refer only to themselves, mutually indifferent manifold of subsistence. Only limit quantitative one. Thing as this is merely quantitative connection, mere collection, their "also." Thing consists of some quantum of matter, also quantum of another, also yet another. Combination, of not having any combination, alone constitutes thing.'
SET c.keyPoints = ['"This" is complete determinateness, external determinateness', 'Thing consists of self-subsistent matters indifferent to connection', 'Matters overrun thing, continue into others', 'Only limit quantitative, thing is merely quantitative connection', 'Combination of not having any combination constitutes thing']
SET c.tags = ['negation', 'sublation', 'thing', 'matter']
SET c.orderInSource = 7
SET c.globalOrder = 26
SET c.sourceText = 'The “this” thus constitutes the\ncomplete determinateness of the thing,\na determinateness which is at the same time\nan external determinateness.\nThe thing consists of self-subsistent matters\nindifferent to the connection they have in the thing.\nThis connection is therefore only\nan unessential linking of them,\nthe difference of one thing from another\ndepending on whether there is in it\na more or less of particular matters\nand in what amount.\nThese matters overrun this thing,\ncontinue into others,\nand that they belong to this thing\nis no restriction for them.\nJust as little are they, moreover,\na restriction for one another,\nfor their negative connection is\nonly the impotent “this.”\nHence, in being linked together in it,\nthey do not sublate themselves;\nthey are as self-subsistent,\nimpenetrable to each other;\nin their determinateness they refer only to themselves\nand are a mutually indifferent manifold of subsistence;\nthe only limit of which they are capable is a quantitative one.\nThe thing as this is just their merely quantitative connection,\na mere collection, their “also.”\nThe thing consists of some quantum or other of a matter,\nalso of the quantum of another, and also of yet another;\nthis combination, of not having any combination\nalone constitutes the thing.';
MATCH (s:SourceText {id: 'source-matter'})
MATCH (c:IntegratedChunk {id: 'mat-7'})
MERGE (s)-[:HAS_CHUNK]->(c);
MERGE (kp:KeyPoint {id: 'mat-7:kp:1'})
SET kp.chunkId = 'mat-7'
SET kp.ordinal = 1
SET kp.text = '"This" is complete determinateness, external determinateness';
MATCH (c:IntegratedChunk {id: 'mat-7'})
MATCH (kp:KeyPoint {id: 'mat-7:kp:1'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'mat-7:kp:2'})
SET kp.chunkId = 'mat-7'
SET kp.ordinal = 2
SET kp.text = 'Thing consists of self-subsistent matters indifferent to connection';
MATCH (c:IntegratedChunk {id: 'mat-7'})
MATCH (kp:KeyPoint {id: 'mat-7:kp:2'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'mat-7:kp:3'})
SET kp.chunkId = 'mat-7'
SET kp.ordinal = 3
SET kp.text = 'Matters overrun thing, continue into others';
MATCH (c:IntegratedChunk {id: 'mat-7'})
MATCH (kp:KeyPoint {id: 'mat-7:kp:3'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'mat-7:kp:4'})
SET kp.chunkId = 'mat-7'
SET kp.ordinal = 4
SET kp.text = 'Only limit quantitative, thing is merely quantitative connection';
MATCH (c:IntegratedChunk {id: 'mat-7'})
MATCH (kp:KeyPoint {id: 'mat-7:kp:4'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'mat-7:kp:5'})
SET kp.chunkId = 'mat-7'
SET kp.ordinal = 5
SET kp.text = 'Combination of not having any combination constitutes thing';
MATCH (c:IntegratedChunk {id: 'mat-7'})
MATCH (kp:KeyPoint {id: 'mat-7:kp:5'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (s:SourceText {id: 'source-dissolution'})
SET s.title = 'C. DISSOLUTION OF THE THING'
SET s.sourceFile = 'relative/essence/appearance/thing/sources/dissolution.txt'
SET s.totalLines = 112;
MATCH (ir:IntegratedIR {id: 'integrated-appearance-thing-topicmap-ir'})
MATCH (s:SourceText {id: 'source-dissolution'})
MERGE (ir)-[:HAS_SOURCE]->(s);
MERGE (c:IntegratedChunk {id: 'dis-1'})
SET c.title = 'Thing absolutely alterable — dissolution'
SET c.sourceId = 'source-dissolution'
SET c.sourceFile = 'relative/essence/appearance/thing/sources/dissolution.txt'
SET c.lineStart = 4
SET c.lineEnd = 18
SET c.description = 'Thing, as merely quantitative combination of free matters, is absolutely alterable. Alteration consists in matters being dropped from collection, added to \'also,\' or rearrangement of matters\' quantitative ratio. Coming-to-be and passing-away is external dissolution of external bond, binding for which indifferent whether bound or not. Stuffs circulate unchecked in or out of \'this\' thing. Thing itself is absolute porosity without measure or form of its own.'
SET c.keyPoints = ['Thing is absolutely alterable', 'Alteration: matters dropped, added, or rearranged', 'External dissolution of external bond', 'Absolute porosity without measure or form']
SET c.tags = ['thing', 'matter']
SET c.orderInSource = 1
SET c.globalOrder = 27
SET c.sourceText = 'This thing, in the manner it has determined itself\nas the merely quantitative combination of free matters,\nis the absolutely alterable.\nIts alteration consists in one or more matters\nbeing dropped from the collection,\nor being added to this “also,”\nor in the rearrangement of the matters\'\nrespective quantitative ratio.\nThe coming-to-be and the passing-away of this thing is\nthe external dissolution of such an external bond,\nor the binding of such for which it is indifferent\nwhether they are bound or not.\nThe stuffs circulate unchecked in or out of “this” thing,\nand the thing itself is absolute porosity\nwithout measure or form of its own.';
MATCH (s:SourceText {id: 'source-dissolution'})
MATCH (c:IntegratedChunk {id: 'dis-1'})
MERGE (s)-[:HAS_CHUNK]->(c);
MERGE (kp:KeyPoint {id: 'dis-1:kp:1'})
SET kp.chunkId = 'dis-1'
SET kp.ordinal = 1
SET kp.text = 'Thing is absolutely alterable';
MATCH (c:IntegratedChunk {id: 'dis-1'})
MATCH (kp:KeyPoint {id: 'dis-1:kp:1'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'dis-1:kp:2'})
SET kp.chunkId = 'dis-1'
SET kp.ordinal = 2
SET kp.text = 'Alteration: matters dropped, added, or rearranged';
MATCH (c:IntegratedChunk {id: 'dis-1'})
MATCH (kp:KeyPoint {id: 'dis-1:kp:2'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'dis-1:kp:3'})
SET kp.chunkId = 'dis-1'
SET kp.ordinal = 3
SET kp.text = 'External dissolution of external bond';
MATCH (c:IntegratedChunk {id: 'dis-1'})
MATCH (kp:KeyPoint {id: 'dis-1:kp:3'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'dis-1:kp:4'})
SET kp.chunkId = 'dis-1'
SET kp.ordinal = 4
SET kp.text = 'Absolute porosity without measure or form';
MATCH (c:IntegratedChunk {id: 'dis-1'})
MATCH (kp:KeyPoint {id: 'dis-1:kp:4'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (c:IntegratedChunk {id: 'dis-2'})
SET c.title = 'Absolutely dissoluble thing — externality'
SET c.sourceId = 'source-dissolution'
SET c.sourceFile = 'relative/essence/appearance/thing/sources/dissolution.txt'
SET c.lineStart = 20
SET c.lineEnd = 31
SET c.description = 'Thing, in absolute determinateness through which it is \'this,\' is absolutely dissoluble thing. Dissolution is external process of being determined, just like being of thing. But dissolution and externality of being is essential of this being. Thing is only \'also,\' consists only of externality. But consists also of matters. Not just abstract \'this\' but \'this\' thing whole is dissolution of itself. Thing determined as external collection of self-subsisting matters.'
SET c.keyPoints = ['Absolutely dissoluble thing', 'Dissolution and externality essential of being', 'Thing is only \'also,\' consists only of externality', '\'This\' thing whole is dissolution of itself']
SET c.tags = ['thing', 'matter']
SET c.orderInSource = 2
SET c.globalOrder = 28
SET c.sourceText = 'So the thing, in the absolute determinateness\nthrough which it is a “this,”\nis the absolutely dissoluble thing.\nThis dissolution is an external process of being determined,\njust like the being of the thing;\nbut its dissolution and the externality of its being\nis the essential of this being;\nthe thing is only the “also”;\nit consists only of this externality.\nBut it consists also of its matters,\nand not just the abstract “this” as such\nbut the “this” thing whole is the dissolution of itself.';
MATCH (s:SourceText {id: 'source-dissolution'})
MATCH (c:IntegratedChunk {id: 'dis-2'})
MERGE (s)-[:HAS_CHUNK]->(c);
MERGE (kp:KeyPoint {id: 'dis-2:kp:1'})
SET kp.chunkId = 'dis-2'
SET kp.ordinal = 1
SET kp.text = 'Absolutely dissoluble thing';
MATCH (c:IntegratedChunk {id: 'dis-2'})
MATCH (kp:KeyPoint {id: 'dis-2:kp:1'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'dis-2:kp:2'})
SET kp.chunkId = 'dis-2'
SET kp.ordinal = 2
SET kp.text = 'Dissolution and externality essential of being';
MATCH (c:IntegratedChunk {id: 'dis-2'})
MATCH (kp:KeyPoint {id: 'dis-2:kp:2'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'dis-2:kp:3'})
SET kp.chunkId = 'dis-2'
SET kp.ordinal = 3
SET kp.text = 'Thing is only \'also,\' consists only of externality';
MATCH (c:IntegratedChunk {id: 'dis-2'})
MATCH (kp:KeyPoint {id: 'dis-2:kp:3'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'dis-2:kp:4'})
SET kp.chunkId = 'dis-2'
SET kp.ordinal = 4
SET kp.text = '\'This\' thing whole is dissolution of itself';
MATCH (c:IntegratedChunk {id: 'dis-2'})
MATCH (kp:KeyPoint {id: 'dis-2:kp:4'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (c:IntegratedChunk {id: 'dis-3'})
SET c.title = 'Matters — negative reference'
SET c.sourceId = 'source-dissolution'
SET c.sourceFile = 'relative/essence/appearance/thing/sources/dissolution.txt'
SET c.lineStart = 32
SET c.lineEnd = 54
SET c.description = 'Matters are not things, lack negative self-subsistence. Properties are rather self-subsistent, determined with being reflected into itself. Matters are simple, referring only to themselves. But content is determinateness. Immanent reflection only form of content. Content not reflected-into-itself but refers to other according to determinateness. Thing not only \'also\' but equally negative reference. On account of determinateness, matters themselves negative reflection, which is puncticity of thing. One matter is not what other is, one is not to extent other is.'
SET c.keyPoints = ['Matters lack negative self-subsistence', 'Content is determinateness, refers to other', 'Matters themselves negative reflection, puncticity', 'One matter not what other is']
SET c.tags = ['negation', 'reflection', 'thing', 'matter']
SET c.orderInSource = 3
SET c.globalOrder = 29
SET c.sourceText = 'For the thing is determined as an external collection\nof self-subsisting matters;\nsuch matters are not things,\nthey lack negative self-subsistence;\nit is the properties which are rather self-subsistent,\nthat is to say, are determined with a being\nwhich, as such, is reflected into itself.\nHence the matters are indeed simple, referring only to themselves;\nbut it is their content which is a determinateness;\nthe immanent reflection is only the form of this content,\na content which is not, as such, reflected-into-itself\nbut refers to an other according to its determinateness.\nThe thing, therefore, is not only their “also,”\nis not their reference to each other as indifferent\nbut is, on the contrary, equally so their negative reference;\nand on account of their determinateness\nthe matters are themselves this negative reflection\nwhich is the puncticity of the thing.\nThe one matter is not what the other is\naccording to the determinateness of its content\nas contrasted to that of an other;\nand the one is not to the extent that the other is,\nin accordance with their self-subsistence.';
MATCH (s:SourceText {id: 'source-dissolution'})
MATCH (c:IntegratedChunk {id: 'dis-3'})
MERGE (s)-[:HAS_CHUNK]->(c);
MERGE (kp:KeyPoint {id: 'dis-3:kp:1'})
SET kp.chunkId = 'dis-3'
SET kp.ordinal = 1
SET kp.text = 'Matters lack negative self-subsistence';
MATCH (c:IntegratedChunk {id: 'dis-3'})
MATCH (kp:KeyPoint {id: 'dis-3:kp:1'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'dis-3:kp:2'})
SET kp.chunkId = 'dis-3'
SET kp.ordinal = 2
SET kp.text = 'Content is determinateness, refers to other';
MATCH (c:IntegratedChunk {id: 'dis-3'})
MATCH (kp:KeyPoint {id: 'dis-3:kp:2'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'dis-3:kp:3'})
SET kp.chunkId = 'dis-3'
SET kp.ordinal = 3
SET kp.text = 'Matters themselves negative reflection, puncticity';
MATCH (c:IntegratedChunk {id: 'dis-3'})
MATCH (kp:KeyPoint {id: 'dis-3:kp:3'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'dis-3:kp:4'})
SET kp.chunkId = 'dis-3'
SET kp.ordinal = 4
SET kp.text = 'One matter not what other is';
MATCH (c:IntegratedChunk {id: 'dis-3'})
MATCH (kp:KeyPoint {id: 'dis-3:kp:4'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (c:IntegratedChunk {id: 'dis-4'})
SET c.title = 'Connecting reference — interpenetration'
SET c.sourceId = 'source-dissolution'
SET c.sourceFile = 'relative/essence/appearance/thing/sources/dissolution.txt'
SET c.lineStart = 56
SET c.lineEnd = 72
SET c.description = 'Thing is connecting reference of matters to each other. One matter and other also subsist in it. Yet at same time, one matter does not subsist in it in so far as other does. To extent one matter is in thing, other thereby sublated. But thing at same time \'also,\' subsistence of other matter. In subsistence of one matter, other does not subsist, and also no less subsists in it. So with all diverse matters in respect to each other.'
SET c.keyPoints = ['Thing is connecting reference of matters', 'One subsists, other does not, yet also subsists', 'Self-contradictory subsistence']
SET c.tags = ['sublation', 'thing', 'matter']
SET c.orderInSource = 4
SET c.globalOrder = 30
SET c.sourceText = 'The thing is, therefore, the connecting reference of\nthe matters of which it consists to each other,\nin such a manner that the one matter,\nand the other also, subsist in it,\nand yet, at the same time,\nthe one matter does not subsist\nin it in so far as the other does.\nTo the extent, therefore, that\nthe one matter is in the thing,\nthe other is thereby sublated;\nbut the thing is at the same time\nthe “also,” or the subsistence of the other matter.\nIn the subsistence of the one matter, therefore,\nthe other matter does not subsist,\nand it also no less subsists in it;\nand so with all these diverse matters\nin respect to each other.';
MATCH (s:SourceText {id: 'source-dissolution'})
MATCH (c:IntegratedChunk {id: 'dis-4'})
MERGE (s)-[:HAS_CHUNK]->(c);
MERGE (kp:KeyPoint {id: 'dis-4:kp:1'})
SET kp.chunkId = 'dis-4'
SET kp.ordinal = 1
SET kp.text = 'Thing is connecting reference of matters';
MATCH (c:IntegratedChunk {id: 'dis-4'})
MATCH (kp:KeyPoint {id: 'dis-4:kp:1'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'dis-4:kp:2'})
SET kp.chunkId = 'dis-4'
SET kp.ordinal = 2
SET kp.text = 'One subsists, other does not, yet also subsists';
MATCH (c:IntegratedChunk {id: 'dis-4'})
MATCH (kp:KeyPoint {id: 'dis-4:kp:2'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'dis-4:kp:3'})
SET kp.chunkId = 'dis-4'
SET kp.ordinal = 3
SET kp.text = 'Self-contradictory subsistence';
MATCH (c:IntegratedChunk {id: 'dis-4'})
MATCH (kp:KeyPoint {id: 'dis-4:kp:3'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (c:IntegratedChunk {id: 'dis-5'})
SET c.title = 'Puncticity — porosity'
SET c.sourceId = 'source-dissolution'
SET c.sourceFile = 'relative/essence/appearance/thing/sources/dissolution.txt'
SET c.lineStart = 73
SET c.lineEnd = 101
SET c.description = 'In same respect as one matter subsists, other subsists also. One subsistence of both is puncticity or negative unity of thing. Two interpenetrate absolutely. Thing at same time only \'also\' of matters. These reflected into determinateness, indifferent to one another. In interpenetrating do not touch. Matters essentially porous. One subsists in pores or non-subsistence of others. Others themselves porous. In their pores or non-subsistence, first and all rest subsist. Subsistence at same time sublatedness and subsistence of others. Subsistence of others just as much sublatedness and subsisting of first and all others. Thing is self-contradictory mediation of independent self-subsistence through opposite, through negation, or one self-subsisting matter through subsisting and non-subsisting of other.'
SET c.keyPoints = ['Puncticity or negative unity', 'Interpenetrate absolutely, yet do not touch', 'Matters essentially porous', 'Self-contradictory mediation through subsisting and non-subsisting']
SET c.tags = ['negation', 'sublation', 'reflection', 'thing', 'matter']
SET c.orderInSource = 5
SET c.globalOrder = 31
SET c.sourceText = 'Since it is thus in the same respect\nas the one matter subsists\nthat the other subsists also,\nand this one subsistence of both is\nthe puncticity or the negative unity of the thing,\nthe two interpenetrate absolutely;\nand since the thing is at the same time\nonly the “also” of the matters,\nand these are reflected into their determinateness,\nthey are indifferent to one another,\nand in interpenetrating they do not touch.\nThe matters are, therefore, essentially porous,\nso that the one subsists in the pores\nor in the non-subsistence of the others;\nbut these others are themselves porous;\nin their pores or their non-subsistence\nthe first and also all the rest subsist;\ntheir subsistence is at the same time\ntheir sublatedness and the subsistence of others;\nand this subsistence of the others is\njust as much their sublatedness\nand the subsisting of the first\nand equally so of all others.\nThe thing is, therefore,\nthe self-contradictory mediation of\nindependent self-subsistence through its opposite,\nthat is to say, through its negation,\nor of one self-subsisting matter\nthrough the subsisting and non-subsisting of an other.';
MATCH (s:SourceText {id: 'source-dissolution'})
MATCH (c:IntegratedChunk {id: 'dis-5'})
MERGE (s)-[:HAS_CHUNK]->(c);
MERGE (kp:KeyPoint {id: 'dis-5:kp:1'})
SET kp.chunkId = 'dis-5'
SET kp.ordinal = 1
SET kp.text = 'Puncticity or negative unity';
MATCH (c:IntegratedChunk {id: 'dis-5'})
MATCH (kp:KeyPoint {id: 'dis-5:kp:1'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'dis-5:kp:2'})
SET kp.chunkId = 'dis-5'
SET kp.ordinal = 2
SET kp.text = 'Interpenetrate absolutely, yet do not touch';
MATCH (c:IntegratedChunk {id: 'dis-5'})
MATCH (kp:KeyPoint {id: 'dis-5:kp:2'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'dis-5:kp:3'})
SET kp.chunkId = 'dis-5'
SET kp.ordinal = 3
SET kp.text = 'Matters essentially porous';
MATCH (c:IntegratedChunk {id: 'dis-5'})
MATCH (kp:KeyPoint {id: 'dis-5:kp:3'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'dis-5:kp:4'})
SET kp.chunkId = 'dis-5'
SET kp.ordinal = 4
SET kp.text = 'Self-contradictory mediation through subsisting and non-subsisting';
MATCH (c:IntegratedChunk {id: 'dis-5'})
MATCH (kp:KeyPoint {id: 'dis-5:kp:4'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (c:IntegratedChunk {id: 'dis-6'})
SET c.title = 'Concrete existence — appearance'
SET c.sourceId = 'source-dissolution'
SET c.sourceFile = 'relative/essence/appearance/thing/sources/dissolution.txt'
SET c.lineStart = 103
SET c.lineEnd = 111
SET c.description = 'In \'this\' thing, concrete existence has attained completion. At once being that exists in itself, independent subsistence, and unessential concrete existence. Truth of concrete existence: has its in-itself in unessentiality. Subsists in other, indeed absolute other. Has its own nothingness for substrate. It is, therefore, appearance.'
SET c.keyPoints = ['Concrete existence has attained completion', 'Has its in-itself in unessentiality', 'Subsists in absolute other, has nothingness for substrate', 'It is, therefore, appearance']
SET c.tags = ['thing', 'appearance']
SET c.orderInSource = 6
SET c.globalOrder = 32
SET c.sourceText = 'In “this” thing, concrete existence has attained its completion,\nnamely, that it is at once being that exists in itself,\nor independent subsistence, and unessential concrete existence.\nThe truth of concrete existence is thus this:\nthat it has its in-itself in unessentiality,\nor that it subsists in an other,\nindeed in the absolute other,\nor that it has its own nothingness for substrate.\nIt is, therefore, appearance.';
MATCH (s:SourceText {id: 'source-dissolution'})
MATCH (c:IntegratedChunk {id: 'dis-6'})
MERGE (s)-[:HAS_CHUNK]->(c);
MERGE (kp:KeyPoint {id: 'dis-6:kp:1'})
SET kp.chunkId = 'dis-6'
SET kp.ordinal = 1
SET kp.text = 'Concrete existence has attained completion';
MATCH (c:IntegratedChunk {id: 'dis-6'})
MATCH (kp:KeyPoint {id: 'dis-6:kp:1'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'dis-6:kp:2'})
SET kp.chunkId = 'dis-6'
SET kp.ordinal = 2
SET kp.text = 'Has its in-itself in unessentiality';
MATCH (c:IntegratedChunk {id: 'dis-6'})
MATCH (kp:KeyPoint {id: 'dis-6:kp:2'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'dis-6:kp:3'})
SET kp.chunkId = 'dis-6'
SET kp.ordinal = 3
SET kp.text = 'Subsists in absolute other, has nothingness for substrate';
MATCH (c:IntegratedChunk {id: 'dis-6'})
MATCH (kp:KeyPoint {id: 'dis-6:kp:3'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MERGE (kp:KeyPoint {id: 'dis-6:kp:4'})
SET kp.chunkId = 'dis-6'
SET kp.ordinal = 4
SET kp.text = 'It is, therefore, appearance';
MATCH (c:IntegratedChunk {id: 'dis-6'})
MATCH (kp:KeyPoint {id: 'dis-6:kp:4'})
MERGE (c)-[:HAS_KEY_POINT]->(kp);
MATCH (a:IntegratedChunk {id: 'thg-1'})
MATCH (b:IntegratedChunk {id: 'thg-2'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'thg-1'})
MATCH (b:IntegratedChunk {id: 'thg-2'})
MERGE (a)-[r:SUBLATES]->(b)
SET r.reason = 'Dialectical transition inferred from thg-2 semantics.';
MATCH (a:IntegratedChunk {id: 'thg-2'})
MATCH (b:IntegratedChunk {id: 'thg-3'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'thg-2'})
MATCH (b:IntegratedChunk {id: 'thg-3'})
MERGE (a)-[r:MEDIATES]->(b)
SET r.reason = 'Dialectical transition inferred from thg-3 semantics.';
MATCH (a:IntegratedChunk {id: 'thg-3'})
MATCH (b:IntegratedChunk {id: 'thg-4'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'thg-3'})
MATCH (b:IntegratedChunk {id: 'thg-4'})
MERGE (a)-[r:SUBLATES]->(b)
SET r.reason = 'Dialectical transition inferred from thg-4 semantics.';
MATCH (a:IntegratedChunk {id: 'thg-4'})
MATCH (b:IntegratedChunk {id: 'thg-5'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'thg-4'})
MATCH (b:IntegratedChunk {id: 'thg-5'})
MERGE (a)-[r:NEGATES]->(b)
SET r.reason = 'Dialectical transition inferred from thg-5 semantics.';
MATCH (a:IntegratedChunk {id: 'thg-5'})
MATCH (b:IntegratedChunk {id: 'thg-6'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'thg-5'})
MATCH (b:IntegratedChunk {id: 'thg-6'})
MERGE (a)-[r:NEGATES]->(b)
SET r.reason = 'Dialectical transition inferred from thg-6 semantics.';
MATCH (a:IntegratedChunk {id: 'thg-6'})
MATCH (b:IntegratedChunk {id: 'thg-7'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'thg-6'})
MATCH (b:IntegratedChunk {id: 'thg-7'})
MERGE (a)-[r:NEGATES]->(b)
SET r.reason = 'Dialectical transition inferred from thg-7 semantics.';
MATCH (a:IntegratedChunk {id: 'thg-7'})
MATCH (b:IntegratedChunk {id: 'thg-8'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'thg-7'})
MATCH (b:IntegratedChunk {id: 'thg-8'})
MERGE (a)-[r:NEGATES]->(b)
SET r.reason = 'Dialectical transition inferred from thg-8 semantics.';
MATCH (a:IntegratedChunk {id: 'thg-8'})
MATCH (b:IntegratedChunk {id: 'thg-9'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'thg-8'})
MATCH (b:IntegratedChunk {id: 'thg-9'})
MERGE (a)-[r:SUBLATES]->(b)
SET r.reason = 'Dialectical transition inferred from thg-9 semantics.';
MATCH (a:IntegratedChunk {id: 'thg-9'})
MATCH (b:IntegratedChunk {id: 'thg-10'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'thg-9'})
MATCH (b:IntegratedChunk {id: 'thg-10'})
MERGE (a)-[r:SUBLATES]->(b)
SET r.reason = 'Dialectical transition inferred from thg-10 semantics.';
MATCH (a:IntegratedChunk {id: 'thg-10'})
MATCH (b:IntegratedChunk {id: 'thg-11'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'thg-10'})
MATCH (b:IntegratedChunk {id: 'thg-11'})
MERGE (a)-[r:REFLECTS]->(b)
SET r.reason = 'Dialectical transition inferred from thg-11 semantics.';
MATCH (a:IntegratedChunk {id: 'thg-11'})
MATCH (b:IntegratedChunk {id: 'thg-12'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'thg-11'})
MATCH (b:IntegratedChunk {id: 'thg-12'})
MERGE (a)-[r:SUBLATES]->(b)
SET r.reason = 'Dialectical transition inferred from thg-12 semantics.';
MATCH (a:IntegratedChunk {id: 'thg-12'})
MATCH (b:IntegratedChunk {id: 'thg-13'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'thg-12'})
MATCH (b:IntegratedChunk {id: 'thg-13'})
MERGE (a)-[r:MEDIATES]->(b)
SET r.reason = 'Dialectical transition inferred from thg-13 semantics.';
MATCH (a:IntegratedChunk {id: 'thg-13'})
MATCH (b:IntegratedChunk {id: 'thg-14'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'thg-13'})
MATCH (b:IntegratedChunk {id: 'thg-14'})
MERGE (a)-[r:REFLECTS]->(b)
SET r.reason = 'Dialectical transition inferred from thg-14 semantics.';
MATCH (a:IntegratedChunk {id: 'thg-14'})
MATCH (b:IntegratedChunk {id: 'thg-15'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'thg-14'})
MATCH (b:IntegratedChunk {id: 'thg-15'})
MERGE (a)-[r:NEGATES]->(b)
SET r.reason = 'Dialectical transition inferred from thg-15 semantics.';
MATCH (a:IntegratedChunk {id: 'thg-15'})
MATCH (b:IntegratedChunk {id: 'thg-16'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'thg-15'})
MATCH (b:IntegratedChunk {id: 'thg-16'})
MERGE (a)-[r:MEDIATES]->(b)
SET r.reason = 'Dialectical transition inferred from thg-16 semantics.';
MATCH (a:IntegratedChunk {id: 'thg-16'})
MATCH (b:IntegratedChunk {id: 'thg-17'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'thg-16'})
MATCH (b:IntegratedChunk {id: 'thg-17'})
MERGE (a)-[r:REFLECTS]->(b)
SET r.reason = 'Dialectical transition inferred from thg-17 semantics.';
MATCH (a:IntegratedChunk {id: 'thg-17'})
MATCH (b:IntegratedChunk {id: 'thg-18'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'thg-17'})
MATCH (b:IntegratedChunk {id: 'thg-18'})
MERGE (a)-[r:NEGATES]->(b)
SET r.reason = 'Dialectical transition inferred from thg-18 semantics.';
MATCH (a:IntegratedChunk {id: 'thg-18'})
MATCH (b:IntegratedChunk {id: 'thg-19'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'thg-18'})
MATCH (b:IntegratedChunk {id: 'thg-19'})
MERGE (a)-[r:NEGATES]->(b)
SET r.reason = 'Dialectical transition inferred from thg-19 semantics.';
MATCH (a:IntegratedChunk {id: 'mat-1'})
MATCH (b:IntegratedChunk {id: 'mat-2'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'mat-1'})
MATCH (b:IntegratedChunk {id: 'mat-2'})
MERGE (a)-[r:NEGATES]->(b)
SET r.reason = 'Dialectical transition inferred from mat-2 semantics.';
MATCH (a:IntegratedChunk {id: 'mat-2'})
MATCH (b:IntegratedChunk {id: 'mat-3'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'mat-2'})
MATCH (b:IntegratedChunk {id: 'mat-3'})
MERGE (a)-[r:NEGATES]->(b)
SET r.reason = 'Dialectical transition inferred from mat-3 semantics.';
MATCH (a:IntegratedChunk {id: 'mat-3'})
MATCH (b:IntegratedChunk {id: 'mat-4'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'mat-3'})
MATCH (b:IntegratedChunk {id: 'mat-4'})
MERGE (a)-[r:NEGATES]->(b)
SET r.reason = 'Dialectical transition inferred from mat-4 semantics.';
MATCH (a:IntegratedChunk {id: 'mat-4'})
MATCH (b:IntegratedChunk {id: 'mat-5'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'mat-4'})
MATCH (b:IntegratedChunk {id: 'mat-5'})
MERGE (a)-[r:SUBLATES]->(b)
SET r.reason = 'Dialectical transition inferred from mat-5 semantics.';
MATCH (a:IntegratedChunk {id: 'mat-5'})
MATCH (b:IntegratedChunk {id: 'mat-6'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'mat-5'})
MATCH (b:IntegratedChunk {id: 'mat-6'})
MERGE (a)-[r:NEGATES]->(b)
SET r.reason = 'Dialectical transition inferred from mat-6 semantics.';
MATCH (a:IntegratedChunk {id: 'mat-6'})
MATCH (b:IntegratedChunk {id: 'mat-7'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'mat-6'})
MATCH (b:IntegratedChunk {id: 'mat-7'})
MERGE (a)-[r:NEGATES]->(b)
SET r.reason = 'Dialectical transition inferred from mat-7 semantics.';
MATCH (a:IntegratedChunk {id: 'dis-1'})
MATCH (b:IntegratedChunk {id: 'dis-2'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'dis-2'})
MATCH (b:IntegratedChunk {id: 'dis-3'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'dis-2'})
MATCH (b:IntegratedChunk {id: 'dis-3'})
MERGE (a)-[r:NEGATES]->(b)
SET r.reason = 'Dialectical transition inferred from dis-3 semantics.';
MATCH (a:IntegratedChunk {id: 'dis-3'})
MATCH (b:IntegratedChunk {id: 'dis-4'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'dis-3'})
MATCH (b:IntegratedChunk {id: 'dis-4'})
MERGE (a)-[r:SUBLATES]->(b)
SET r.reason = 'Dialectical transition inferred from dis-4 semantics.';
MATCH (a:IntegratedChunk {id: 'dis-4'})
MATCH (b:IntegratedChunk {id: 'dis-5'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'dis-4'})
MATCH (b:IntegratedChunk {id: 'dis-5'})
MERGE (a)-[r:NEGATES]->(b)
SET r.reason = 'Dialectical transition inferred from dis-5 semantics.';
MATCH (a:IntegratedChunk {id: 'dis-5'})
MATCH (b:IntegratedChunk {id: 'dis-6'})
MERGE (a)-[r:NEXT]->(b)
SET r.reason = 'Sequential order in source text.';
MATCH (a:IntegratedChunk {id: 'dis-5'})
MATCH (b:IntegratedChunk {id: 'dis-6'})
MERGE (a)-[r:REFLECTS]->(b)
SET r.reason = 'Dialectical transition inferred from dis-6 semantics.';
MATCH (a:IntegratedChunk {id: 'thg-19'})
MATCH (b:IntegratedChunk {id: 'mat-1'})
MERGE (a)-[r:SUBLATES]->(b)
SET r.reason = 'Thinghood passes into constitution through self-subsistent matters.';
MATCH (a:IntegratedChunk {id: 'mat-7'})
MATCH (b:IntegratedChunk {id: 'dis-1'})
MERGE (a)-[r:SUBLATES]->(b)
SET r.reason = 'Constitution out of matters culminates in dissolution of the thing.';