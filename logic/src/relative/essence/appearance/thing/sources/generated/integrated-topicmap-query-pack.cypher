// Neo4j Query Pack — Integrated Appearance/Thing IR
// IR: integrated-appearance-thing-topicmap-ir
// Generated for section: Doctrine of Essence / Appearance / Thing
...
MATCH (c:IntegratedChunk {id: 'dis-6'})-[:HAS_KEY_POINT]->(k:KeyPoint)
