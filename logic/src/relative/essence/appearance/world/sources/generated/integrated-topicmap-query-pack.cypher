// Neo4j Query Pack — Integrated Appearance/World IR
// IR: integrated-appearance-world-topicmap-ir
// Generated for section: Doctrine of Essence / Appearance / World
...
MATCH (c:IntegratedChunk {id: 'disa-6'})-[:HAS_KEY_POINT]->(k:KeyPoint)
