...
MERGE (protocol:CITProtocol {id: 'cit-citi-citta-essence-debug-ir'})
SET protocol.mode = 'debug'
SET protocol.title = 'Integrated Chunking/TopicMap IR — CIT-CITI-CITTA'
SET protocol.section = 'Doctrine of Essence / Reflection / Foundation'
SET protocol.generatedAt = '2026-02-17T15:07:41.457Z'
...
SET citta.title = 'Hegelian Science of Reflection';
...
MATCH (protocol:CITProtocol {id: 'cit-citi-citta-essence-debug-ir'})
...
SET layer.title = 'Principle of Reflection (CITTA)'
SET layer.kind = 'PRINCIPLE'
SET layer.description = 'Hegelian starting determination where immediate and conceptual moments are sublated into reflected unity (CITTA).'
