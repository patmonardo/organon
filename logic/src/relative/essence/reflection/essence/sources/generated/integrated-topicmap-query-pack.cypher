// Neo4j Query Pack — Integrated Reflection/Essence IR
// IR: integrated-reflection-essence-topicmap-ir
// Generated for section: Doctrine of Essence / Reflection / Essence
...
MATCH (c:IntegratedChunk {id: 'ref-14'})-[:HAS_KEY_POINT]->(k:KeyPoint)
