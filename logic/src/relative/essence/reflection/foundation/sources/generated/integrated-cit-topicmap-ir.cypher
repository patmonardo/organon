...
MERGE (protocol:CITProtocol {id: 'cit-citi-citta-reflection-debug-ir-foundation'})
SET protocol.mode = 'debug'
SET protocol.title = 'Integrated Reflection Chunking/TopicMap IR — CIT-CITI-CITTA'
SET protocol.section = 'Doctrine of Essence / Reflection / Foundation + Ground / FOUNDATION'
SET protocol.generatedAt = '2026-02-17T13:17:59.335Z'
SET protocol.totalSources = 3
SET protocol.totalChunks = 31;
...
SET s.totalLines = 64;
MATCH (protocol:CITProtocol {id: 'cit-citi-citta-reflection-debug-ir-foundation'})
