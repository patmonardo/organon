...
MERGE (protocol:CITProtocol {id: 'cit-citi-citta-reflection-debug-ir-ground'})
SET protocol.mode = 'debug'
SET protocol.title = 'Integrated Reflection Chunking/TopicMap IR — CIT-CITI-CITTA'
SET protocol.section = 'Doctrine of Essence / Reflection / Foundation + Ground / GROUND'
SET protocol.generatedAt = '2026-02-17T13:17:59.335Z'
SET protocol.totalSources = 3
SET protocol.totalChunks = 46;
...
MATCH (protocol:CITProtocol {id: 'cit-citi-citta-reflection-debug-ir-ground'})
