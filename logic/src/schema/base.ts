...
export const IdentityQualitySchema = z
  .object({
...
export const TemporalQualitySchema = z
  .object({
...
export const ExistentialQualitySchema = z
  .object({
...
export const BaseSchema = IdentityQualitySchema.merge(
...
export const BaseShapeSchema = z
  .object({
