...
export const ContextSchema = z.object({
  ...
  kriya_dynamics: z.object({
    ...
    manifestation_readiness: z.enum(['latent', 'activating', 'manifest']).default('latent'),
  ...
  // Context metadata
  scope_level: z.enum(['local', 'regional', 'global', 'universal']).default('local'),
...
export const PropertySchema = z.object({
  ...
  // Property metadata
  determinacy_level: z.enum(['vague', 'specific', 'precise']).default('specific'),
...
export const EssenceSchema = z.object({
  ...
  kriya_field: z.object({
    manifestation_readiness: z.enum(['potential', 'dynamic', 'actualized']).default('potential'),
  ...
  mediation_quality: z.enum(['immediate', 'reflected', 'absolute']).default('reflected'),
  determination_mode: z.enum(['external', 'internal', 'self-determining']).default('internal'),
  ...
  public static createReflectiveEssence(
    ...
    return {
      context: {
        ...
        kriya_dynamics: {
          experiential_potentials: ['environmental-awareness', 'contextual-sensitivity'],
          manifestation_readiness: 'latent',
          dharmic_resonance: ['contextual-dharma', 'environmental-responsiveness'],
        },
        scope_level: 'local',
      ...
      property: {
        ...
        kriya_manifestation: {
          agential_perspective: { perspective_type: 'reflective', clarity_level: 'moderate' },
          filtering_mechanisms: ['contextual-filtering', 'qualitative-selection'],
          practical_expressions: ['property-manifestation', 'contextual-adaptation'],
        },
        attribute_values: { quality: qualitativeCharacter, context_binding: environmentalField },
        determinacy_level: 'specific',
        contextual_dependency: 7,
      },

      dialectical_mediation: {
        context_property_synthesis: 'Context and Property mutually determine through reflective mediation',
        reflection_dynamics: 'Essential reflection where context determines property and property modifies context',
        possibility_field: 'Opens field of essential possibilities through contextual-qualitative mediation',
      },
  ...
  public static createAbsoluteEssence(
    ...
    return {
      context: {
        ...
        kriya_dynamics: {
          experiential_potentials: ['universal-awareness', 'absolute-contextuality', 'total-environmental-integration'],
          manifestation_readiness: 'manifest',
          dharmic_resonance: ['universal-dharma', 'absolute-responsiveness', 'cosmic-harmonization'],
        },
      ...
      property: {
        ...
        kriya_manifestation: {
          ...
          filtering_mechanisms: ['universal-discrimination', 'absolute-selection', 'perfect-judgment'],
          practical_expressions: ['absolute-manifestation', 'universal-adaptation', 'perfect-expression'],
        },
        attribute_values: {
      ...
      dialectical_mediation: {
        context_property_synthesis: 'Absolute synthesis where Context and Property are identical in their self-determination',
        reflection_dynamics: 'Absolute reflection - essence reflects itself as the totality of its determinations',
        possibility_field: 'Opens the absolute field of all essential possibilities through self-determining mediation',
      },

      kriya_field: {
        manifestation_readiness: 'actualized',
        experiential_transformation: 'Complete integration of essence and experience',
