...
import {
  isWholeGround,
  computeGroundCardinality,
  computeRelationDegrees,
  suggestModalityForGround,
  classifyTruthOfGround,
  classifyTruthOfRelation,
  locateTranscendental,
} from '../../src/absolute/core/qualquant';
...
describe('Qualitative/Quantitative helpers', () => {
  ...
  it('classifies truth of relation (Mechanism/Chemism/Teleology) and locates transcendental', () => {
    const abs: any = {
      ...
      provenance: { metaphysics: { intuition: 'intellectual' } },
    };
    const rel1: any = {
      id: 'rel1',
      sourceId: 'S',
      ...
      provenance: { metaphysics: { intuition: 'inner' } },
    };
    const rel2: any = {
      id: 'rel2',
      sourceId: 'S',
    ...
    expect(classifyTruthOfRelation(rel1, rels, {}, { properties: props })).toBe(
      'Chemism',
    );
