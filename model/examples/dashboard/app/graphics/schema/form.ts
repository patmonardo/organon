//@graphics/schema/form.ts
import { z } from "zod";

// Define FormMatter type
export const FormMatterSchema = z.record(z.string(), z.any()).optional();
...
export const FormHandlerSchema = z.object({
  submit: z.custom<(...args: any[]) => any>(),
  reset: z.custom<(...args: any[]) => any>().optional(),
  cancel: z.custom<(...args: any[]) => any>().optional(),
  delete: z.custom<(...args: any[]) => any>().optional(),
});
