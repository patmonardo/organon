...
Status: active
Applies to: all Becoming-Essence workbooks in this folder
...
- Relations may include broader inferential structure only as second-order modeling artifacts, not as first-order source claims.
...
- Current sequencing default for this track: `Absolute Indifference -> Inverse Ratio -> Transition into Essence -> relation-expansion cycles`.
