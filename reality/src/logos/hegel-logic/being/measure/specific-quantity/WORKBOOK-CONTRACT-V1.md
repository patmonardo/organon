...
Status: active
Applies to: all Specific Quantity workbooks in this folder
...
- Current sequencing default for this track: `Specific Quantum -> Specifying Measure -> Being-for-itself in Measure -> relation-expansion cycles`.
