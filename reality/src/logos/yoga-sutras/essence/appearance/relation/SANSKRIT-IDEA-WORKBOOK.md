# Appearance/Relation - SANSKRIT IDEA WORKBOOK
...
## Sūtra IV.19: The Mind as Object
...
The preceding sutra (IV.18) established the _Puruṣa_ as the ultimate, invariant Witness to the fluctuating mind. IV.19 immediately locks down the consequence of that geometry: if the mind is witnessed, the mind is an object.
...
## Sūtra IV.20: The Prohibition of Double-Determination
...
If the mind is not self-luminous (IV.19), could it rapidly alternate between being the seer and the seen to fake self-luminosity? Patañjali says no, introducing a strict physical limit on cognitive acts.
...
## Sūtra IV.21: The Refutation of Mind-on-Mind Transparency
...
If a single mind cannot see itself (IV.20), perhaps _Mind B_ can look directly into the machinery of _Mind A_? Patañjali uses a reductio ad absurdum to obliterate this idea of direct metaphysical telepathy.

If minds were structurally transparent to other minds (_citta-antara-dṛśye_), the geometry of the universe would collapse into an infinite regress (_atiprasaṅga_). Mind A sees Mind B, but who sees Mind A? Mind C? And who sees Mind C? The "intellect upon intellect" (_buddhi-buddher_) stacking creates a paradox where no cognitive act can ever be grounded.
