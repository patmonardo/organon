...
- Use ID prefix `realm-ind` for Part B entries.
...
- Planned entries:
  - `realm-ind-001` -> paragraphs 1-2 (`4-45`)
  - `realm-ind-002` -> paragraphs 3-4 (`47-101`)
  - `realm-ind-003` -> transition paragraph (`103-135`)

### Entry realm-ind-001 — Exclusive affinity with internal indifference and substrate requirement
...
- r1. type: supports
  ...
  - sourceClaimIds: [`realm-ind-001-c1`, `realm-ind-001-c2`]
  - sourceKeyPointIds: [`k1`, `k2`]
  - targetClaimIds: [`realm-mea-c-c-c2`, `realm-mea-c-c-c3`]
  - logicalOperator: implicative_support
  - analysisMode: first_order_claim_projection

- r2. type: transitions_to
  - targetEntryId: realm-ind-002
  - note: substrate-bearing exclusive measure externalizes itself and forms nodal alternation.
  - sourceClaimIds: [`realm-ind-001-c3`]
  - sourceKeyPointIds: [`k4`]
  - targetClaimIds: [`realm-ind-002-c1`]
...
### Entry realm-ind-002 — Self-repelling measure, nodal alternation, and qualitative leap
...
- r1. type: transitions_to
  ...
  - sourceClaimIds: [`realm-ind-002-c3`]
  - sourceKeyPointIds: [`k4`]
  - targetClaimIds: [`realm-ind-003-c1`]
  - logicalOperator: sequential_transition
  - analysisMode: first_order_claim_projection
...
### Entry realm-ind-003 — Transition: critique of gradualness and conceptual priority of leap
