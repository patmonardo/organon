...
export const CHUNKS_I_46 = [
  {
    ...
    source:
      '(note) Closure of vitarka–vicāra (Objective Logic); bridge from Aviseṣa/Liṅga-mātra to samādhi track (dhāraṇā–dhyāna–samādhi).',
  },
]
...
export const HLOS_I_46 = [
  {
    ...
    clauses: [
      "tag('sutra','I.46')","tag('moment','closure')","tag('mode','vicara')","tag('phase','savicara')",
      "tag('lens','fichte')","tag('scope','essence')",
