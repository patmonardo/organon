...
export const YS_III_55_ANALYSIS: SutraAnalysis = {
  text: {
    ref: makeSutraRef('III', 55),
    devanagari:
      'तारकं सर्वविषयं सर्वथाविषयमक्रमञ्चेति विवेकजं ज्ञानम्',
    iast: 'tārakaṃ sarvaviṣayaṃ sarvathāviṣayam akramañ ceti vivekajaṃ jñānam',
  },
  syllables: [
    { text: 'tā', script: 'iast' },
    { text: 'ra', script: 'iast' },
    { text: 'kaṃ', script: 'iast' },
    { text: 'sar', script: 'iast' },
    { text: 'va', script: 'iast' },
    { text: 'vi', script: 'iast' },
    { text: 'ṣa', script: 'iast' },
    { text: 'yaṃ', script: 'iast' },
    { text: 'sar', script: 'iast' },
    { text: 'va', script: 'iast' },
    { text: 'thā', script: 'iast' },
    { text: 'vi', script: 'iast' },
    { text: 'ṣa', script: 'iast' },
    { text: 'yam', script: 'iast' },
    { text: 'a', script: 'iast' },
    { text: 'kra', script: 'iast' },
    { text: 'mañ', script: 'iast' },
    { text: 'ce', script: 'iast' },
    { text: 'ti', script: 'iast' },
    { text: 'vi', script: 'iast' },
    { text: 've', script: 'iast' },
    { text: 'ka', script: 'iast' },
    { text: 'jaṃ', script: 'iast' },
    { text: 'jñā', script: 'iast' },
    { text: 'nam', script: 'iast' },
  ],
  padaccheda: [
    { surface: 'tārakam', gloss: 'deliverative / leading-across' },
    { surface: 'sarva-viṣayam', gloss: 'all-objects (domain-unrestricted)' },
    {
      surface: 'sarvathā-viṣayam',
      gloss: 'in every respect/manner (manner-unrestricted)',
    },
    { surface: 'akramaṃ', gloss: 'non-sequential' },
    { surface: 'ca', gloss: 'and' },
    { surface: 'iti', gloss: 'thus / as characterized' },
    { surface: 'viveka-jam', gloss: 'born of discrimination' },
    { surface: 'jñānam', gloss: 'knowledge' },
  ],
  operators: [
    { kind: 'predicate', token: 'tārakam', claim: 'Knowing functions as the crossing-over.' },
    {
      kind: 'quantifier-domain',
      token: 'sarva-viṣayam',
      claim: 'No restriction on object-domain (∀ objects).',
    },
    {
      kind: 'quantifier-manner',
      token: 'sarvathā-viṣayam',
      claim: 'No restriction on mode/respect (∀ respects).',
    },
    {
      kind: 'temporality',
      token: 'akramaṃ',
      claim: 'Non-stepwise givenness; whole-given (sphoṭa-compatible).',
    },
    { kind: 'source', token: 'viveka-jam', claim: 'Generated by discrimination (viveka).' },
    { kind: 'closure', token: 'ca iti', claim: 'Predicate stack marked as a definition/list.' },
  ],
  sources: [
    {
      id: 'fichte-1804-l27',
      title: 'Fichte, Wissenschaftslehre 1804 — Lecture 27 (June 6, 1804)',
      note: 'Used as the Science-of-Knowing crosswalk for taraka/vivekaja/akrama.',
    },
    {
      id: 'hegel-hp-capila-gunas',
      title: 'Hegel, Lectures on the History of Philosophy — “Sanc’hya of Capila” (guṇas)',
      locator: 'Haldane trans., Vol. 1, p. 134 (approx.)',
      url: 'https://www.marxists.org/reference/archive/hegel/works/hp/hporiental.htm#capila',
      note: 'Triadic determination of the “Absolute Idea” as a bridge into Yoga/Sāṃkhya triads.',
    },
  ],
  thesis:
    'Taraka knowledge is discrimination-born cognition whose scope is total (objects + respects) and whose assembly is non-sequential; it is the epistemic crossing that makes the transition to kaivalya possible.',
};
