...
exports.WorkflowFactory = exports.WorkflowSchema = exports.CoordinationSchema = exports.ProcessSchema = void 0;
...
exports.ProcessSchema = zod_1.z.object({
    ...
    steps: zod_1.z.array(zod_1.z.object({
        id: zod_1.z.string(),
        name: zod_1.z.string(),
        type: zod_1.z.enum(['task', 'decision', 'transformation', 'synthesis']),
        dependencies: zod_1.z.array(zod_1.z.string()).optional(),
        duration: zod_1.z.number().optional(), // Expected duration in milliseconds
        resources: zod_1.z.record(zod_1.z.string(), zod_1.z.any()).optional(),
        // Dialectical structure
        dialecticalRole: zod_1.z
    ...
    approach: zod_1.z
        ...
        .default('linear'),
    adaptability: zod_1.z
        .enum(['fixed', 'flexible', 'self-organizing', 'transcendent'])
        .default('fixed'),
});
// Coordination: The organizational principle that governs the process (Active Concept as systematic unity)
exports.CoordinationSchema = zod_1.z.object({
    id: zod_1.z.string(),
    name: zod_1.z.string(),
    ...
    organizationalPrinciple: zod_1.z
        .enum(['centralized', 'distributed', 'dialectical', 'absolute'])
        .default('centralized'),
    emergenceLevel: zod_1.z
...
exports.WorkflowSchema = zod_1.z
    .object({
    id: zod_1.z.string(),
    process: exports.ProcessSchema,
    coordination: exports.CoordinationSchema,
    // State management
    status: zod_1.z
        .enum([
        'initialized',
    ...
    dialecticalContext: zod_1.z
        ...
        systemicLevel: zod_1.z.enum(['simple', 'complex', 'dialectical', 'absolute']),
        emergentProperties: zod_1.z.array(zod_1.z.string()).optional(),
    })
        .optional(),
    // Performance metrics
    metrics: zod_1.z
        .object({
        efficiency: zod_1.z.number().min(0).max(1).optional(),
        coherence: zod_1.z.number().min(0).max(1).optional(),
        adaptability: zod_1.z.number().min(0).max(1).optional(),
        emergence: zod_1.z.number().min(0).max(1).optional(),
    })
        .optional(),
    // Temporal dimension
...
class WorkflowFactory {
     ...
     */
    static createBeingWorkflow(name, steps) {
        return {
     ...
     */
    static createEssenceWorkflow(name, processes) {
        const allSteps = processes.flatMap((proc, procIndex) => proc.steps.map((step, stepIndex) => {
            let role;
            if (stepIndex % 3 === 0)
                role = 'thesis';
     ...
     */
    static createConceptWorkflow(name, conceptStructure) {
        return {
     ...
     */
    static createAbsoluteWorkflow(name, systemContext) {
        return {
...
exports.default = exports.WorkflowSchema;
